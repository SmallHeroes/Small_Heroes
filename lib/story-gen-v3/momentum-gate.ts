...
const CHILD_ACTION_VERBS =
  'מנסה|מוביל|בונה|דוחף|מסדר|קורא|פותח|מרים|שם|מדביק|מושך|טובל|מצייר|קופץ|מנער|תולה|תול|עוקב|מחזיק|נכנס|מניח|מצביע|מנגב|מודד|עומד|הצביע|הסתכל|טבל|משך|הניח|נשם|ניגב|גיחך|מתגלגל|ניער|תלה|הרים|מדד|מוסיף|אומר|מבחין|מתכונן';
