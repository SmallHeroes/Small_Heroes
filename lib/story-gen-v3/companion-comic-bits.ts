...
export const LION_SHAKET_COMIC_BITS: CompanionComicBit[] = [
  {
    ...
    lineHe: '"אני אהיה מאוד שקט," הכריז לֵיוֹ — בקול שרעיד את המדף.',
    placementHint: 'early_support',
    reusePolicy: 'adapt_required',
  ...
  },
  {
    ...
    actionHe: 'לֵיוֹ מודד את השאגה בכפות הרגליים כמו דג.',
  ...
  },
  {
    ...
    actionHe: 'לֵיוֹ מחזיק לחישה בזהירות — והיא יוצאת כציוץ קטן.',
  ...
  },
  {
    ...
    actionHe: 'הזנב של לֵיוֹ מכה ברצפה על כל מילה שהוא מנסה לומר בשקט.',
  ...
  },
  {
    ...
    actionHe: 'לֵיוֹ מתרגל "שאגה עדינה" — ועלה עדיין עף מהשולחן.',
