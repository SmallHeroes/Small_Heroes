...
export const CANONICAL_LIVE_EXECUTION_REQUEST_MATERIALIZATION_INPUT_VERSION =
  'canonical-live-execution-request-materialization-input/v37' as const;
export const CANONICAL_LIVE_EXECUTION_REQUEST_MATERIALIZATION_RESULT_VERSION =
  'canonical-live-execution-request-materialization-result/v42' as const;
  ...
  const request = buildCanonicalLiveExecutionRequest(
    {
      ...
      canonicalBundle: {
        ...
        representedElsewhereRepairStructuredOutputCompatibility:
          verifiedBundle.representedElsewhereRepairStructuredOutputCompatibility,
        ...
        stablePropScopeRepairStructuredOutputCompatibility:
          verifiedBundle.stablePropScopeRepairStructuredOutputCompatibility,
        requestPolicy: verifiedBundle.requestPolicy,
      },
      preservationFences,
