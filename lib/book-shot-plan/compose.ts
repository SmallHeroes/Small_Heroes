  ...
  switch (shot.shot) {
    case 'establishing_wide':
      return [
        ...
        '- CHARACTER SCALE: small — the CHILD is approx 15–25% of frame height. Do NOT make the companion the same height as the child: size the companion by its own natural body size relative to the child.',
