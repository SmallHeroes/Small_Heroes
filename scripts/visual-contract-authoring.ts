...
export const VISUAL_CONTRACT_AUTHORING_USAGE = [
  ...
  'The current $5 policy admits up to 12 pages: three standard calls plus one strictly gated terminal-reference cleanup; 13+ pages stop before provider access and require a separate budget or partition Decision Gate.',
