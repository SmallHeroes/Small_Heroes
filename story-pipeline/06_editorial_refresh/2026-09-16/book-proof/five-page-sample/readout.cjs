...
const root=path.join(repo,'outputs/panda-five-page-sample-20260919');
const config=JSON.parse(fs.readFileSync(path.join(repo,'outputs/panda-five-page-input-20260919/config.json'),'utf8'));
