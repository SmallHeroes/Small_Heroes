        ...
        <main>
          ...
          <section className="section why-section">
            <div className="wrap">
              ...
              {/* Two curated value panels. Index 0 = the illustrated book (real
                  rendered spread asset), index 1 = narration (built from tokens —
                  no fake audio claim, just the medium made visible). */}
