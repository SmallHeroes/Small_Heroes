 ...
 * The niqqud pass MUST run BEFORE the pause punctuation (it matches on BARE words). Exported (used by
 * `generatePageAudio`; safe to reuse for a narration audition). Throws on empty text.
 */
