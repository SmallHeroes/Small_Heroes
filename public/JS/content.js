  ...
  he: {
    ...
    landing: {
      ...
      pricing: {
        ...
        cards: [
          {
            kicker: 'סיפור לפני שינה', name: 'ספר לילה טוב אישי', pages: '10 עמודים', price: '59',
          ...
          {
            kicker: 'הרפתקה', name: 'הרפתקה אישית', pages: '15 עמודים', price: '79',
            badge: 'בחירת ההשקה',
          ...
          {
            kicker: 'פנטזיה', name: 'ספר פנטזיה אישי', pages: '20 עמודים', price: '99',
