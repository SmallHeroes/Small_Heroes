...
const CONTENT = {
  he: {
    ...
    landing: {
      ...
      hero: {
        badge:       'ספר אישי — נוצר בשביל הילד שלכם',
        h1:          'משהו קשה לו עכשיו?',
        sub:         'פחד לפני שינה, ביקור אצל רופא, אח או אחות חדשים, מעבר בבית או בגן — אתם מספרים מה קשה לו, ואנחנו בונים ספר סביב זה.',
        body:        'ספר ילדים בעברית, עם דמות שמזכירה אותו, סיפור שהוא מזדהה אליו, וסוף שנותן לו משהו להחזיק בו — לא תבנית עם שם.',
        ...
        socialProof: 'בתקופת ההשקה — כל ספר נבנה אישית לפי מה שאתם מספרים',
        trustBadge:  'שאלון קצר · ספר דיגיטלי מאויר · בעברית · מותאם לגיל ולמצב הרגשי',
      ...
      helps: {
        ...
        cards: [
          { title: '🌙 פחדים לפני שינה',           body: 'כשהלילה מרגיש מאיים והילד צריך סיפור שמרגיע ונותן ביטחון.' },
          { title: '🩹 ביקור רפואי או טיפול',      body: 'כשיש חשש מרופא, מחט, בדיקה או בית חולים — בסיפור שמכין בעדינות.' },
          { title: '👶 אח או אחות חדשים',          body: 'כשהמשפחה משתנה והילד צריך להרגיש שעדיין שייך ואהוב.' },
          { title: '🌱 מעבר בבית, בגן או בכיתה',   body: 'כשיש שינוי גדול — מעבר, גן חדש, כיתה חדשה — והרבה לא-ודאות.' },
          { title: '🤝 קושי חברתי או מפגשים',      body: 'כשחברויות, שיתוף או מפגשים חדשים מלחיצים או מבלבלים.' },
          { title: '⚡ כעס, תסכול והתפרצויות',     body: 'כשרגשות חזקים קשים לו (ולכם) — והילד צריך מסגרת רגשית בטוחה.' },
          { title: '🌿 ילד רגיש במיוחד',           body: 'כשעומס, רעשים או שינויים קטנים מרגישים גדולים מדי.' },
          { title: '🌟 ביטחון וערך עצמי',          body: 'כשחשוב לחזק את התחושה שהוא יכול, שייך, ולא לבד עם הקושי.' },
        ],
      },
        ...
        cards: [
          {
            ...
            cta: 'מתאים לנו — שקט וחם', featured: false,
          },
          {
    ...
    wizard: {
      ...
      microcopy: {
        ...
        sStyle: 'עכשיו — איזה סגנון איור מדבר אליכם?',
      ...
      steps: {
        ...
        /* ── Step 11 — Direction ─────────────────────────── */
        sDirection: {
          title: 'איזה סוג סיפור מתאים לו?',
          sub:  'בחרו את האורך והאווירה — אפשר לשנות בכל רגע.',
        },
        ...
        /* ── Step 13 — Package: addons + voice + sleep ───── */
        s8b: {
      ...
      directionPackages: [
        ...
        },
        {
          ...
          pagesLine: '15 עמודים',
          subtitle: '15 עמודים',
          description: 'הסיפור המלא — מספיק עמוק כדי לרגש, קליל מספיק לקריאה נעימה',
          features: [
            '15 עמודים עם איורים מקוריים',
            'דמות מותאמת + עלילה מלאה',
            'הרפתקה עם התפתחות רגשית',
          ],
          price: 79,
          parentPill: 'הבחירה של רוב ההורים',
          ctaChoose: 'לבחירה',
          ctaSelected: 'זו הבחירה שלי',
        },
        {
          ...
          topLabel: 'מסע פלאי',
          label: 'מסע פלאי',
          title: 'דמיון ללא גבולות',
          pagesLine: '20 עמודים',
          subtitle: '20 עמודים',
          description: 'ספר עשיר עם עולם שלם — רגעים שנבנים לאט, עומק אמיתי',
          features: [
            '20 עמודים עם איורים מקוריים',
