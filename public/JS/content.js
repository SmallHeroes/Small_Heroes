  ...
  he: {
    ...
    landing: {
      ...
      gallery: {
        ...
        sub: 'כל ספר נוצר אישית — עם איורים מקוריים, דמות שדומה לילד, וסיפור שמדבר ישירות אליו.',
      ...
      why: {
        ...
        cards: [
          { title: '💜 סיפור שנבנה סביב הקושי שלו', body: 'לא תבנית עם שם — סיפור שנכתב מאפס סביב מה שקשה לילד שלכם עכשיו, עם דמויות ומסר שמותאמים בדיוק לו.' },
          { title: '🎨 איורים מקוריים בשני סגנונות', body: 'כל עמוד מאוייר מחדש. בחרו בין סגנון מאוייר חם לסגנון ריאליסטי — הילד רואה את עצמו בתוך הסיפור.' },
          { title: '⚡ מוכן תוך דקות, לא ימים',     body: 'ממלאים שאלון קצר, בוחרים חבילה — ותוך דקות יש לכם ספר דיגיטלי מוכן לקריאה, עם אפשרות לקריינות ו-PDF.' },
        ],
      },
      ...
      sample: {
        ...
        p1:     '',
        p2:     'הדמות הראשית עוברת בדיוק את מה שהילד שלכם עובר — ומגיעה לסוף שנותן לו משהו להחזיק בו.',
      ...
      how: {
        ...
        steps: [
          ...
          { title: '📖 אנחנו בונים ספר סביב זה', body: 'סיפור מקורי עם דמות שמבוססת על הילד שלכם, איורים מקוריים, ומסר שנכתב בדיוק בשבילו.' },
          { title: '🎧 מוכן לקריאה תוך דקות', body: 'ספר דיגיטלי מלא עם איורים. אפשר להוסיף קריינות או PDF.' },
        ],
      },
