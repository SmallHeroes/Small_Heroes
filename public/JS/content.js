    ...
    landing: {
      ...
      why: {
        ...
        cards: [
          ...
          { title: '🎨 ריאליסטי מאוייר', body: 'איור ריאליסטי וחם, עם דמויות שמרגישות קרובות, נעימות ולא מאיימות — בהשראת הילד/ה שלכם.' },
          { title: '✨ בדיקת איכות לפני מסירה', body: 'הספר נבנה במהירות, ובתקופת ההשקה עובר בדיקת איכות לפני שנשלח אליכם.' },
        ],
      },
      ...
      how: {
        ...
        steps: [
          ...
          { title: '🎧 קוראים יחד', body: 'ספר דיגיטלי מאויר — מוכן לקריאה אחרי בדיקת האיכות. תוספות כמו קריינות או קובץ להדפסה מתוכננות להמשך.' },
        ],
      },
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'זה ספר דיגיטלי או מודפס?',            a: 'הספר מוכן כספר דיגיטלי לקריאה. תוספות כמו קובץ להדפסה או קריינות מתוכננות להמשך.' },
        ],
      },
