    ...
    landing: {
      ...
      why: {
        ...
        cards: [
          ...
          { title: '🃏 כרטיס כוח אישי', body: 'כרטיס Power Card מודפס להורדה — עם מסר ותזכורת מהסיפור, שילד/ה יכול/ה להחזיק כשקשה.' },
        ],
      },
      ...
      how: {
        h2: 'איך זה עובד?',
        steps: [
          { title: '✍️ אתם מספרים לנו עליו', body: 'מה קשה לו, מה עוזר לו, ומה הייתם רוצים שירגיש. לוקח 3 דקות.' },
          { title: '📖 הסיפור נבנה — רק בשבילו', body: 'סיפור אישי, דמות בהשראת הילד/ה, ואיורים שמלווים כל רגע. הכל מותאם למה שסיפרתם.' },
          { title: 'מה הלאה', body: 'ספר דיגיטלי לקריאה, קריינות להאזנה, סרטון לשיתוף, וכרטיס כוח מודפס — מוכן אחרי בדיקת האיכות.' },
        ],
      },
        ...
        cards: [
          {
            ...
            features: ['ספר דיגיטלי מאויר', 'קריינות מקצועית', 'סרטון slideshow לשיתוף', 'כרטיס כוח מודפס (Power Card)'],
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'זה ספר דיגיטלי או מודפס?',            a: 'הספר מגיע כספר דיגיטלי לקריאה והאזנה בקורא האישי, עם סרטון לשיתוף. כרטיס הכוח נשלח כקובץ מודפס להורדה. הכל כלול בכל חבילה — בלי תוספות.' },
        ],
      },
