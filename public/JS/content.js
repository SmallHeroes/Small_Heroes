...
const CONTENT = {
  he: {
    ...
    landing: {
      ...
      hero: {
        badge:
          'חבילה אחת לילד שלכם — ספר דיגיטלי מאויר עם קריינות מלאה',
        h1:          'משהו קשה לילד שלכם עכשיו?',
        sub:
          'הילד שלכם לא לבד עם מה שקשה לו. אתם מספרים מה הוא עובר — ואנחנו יוצרים ספר אישי בעברית: דמות בהשראתו, חבר מלווה, וסיפור עם סוף שנותן משהו קטן וחזק לקחת הלאה.',
        ctaPrimary:  'ליצור ספר לילד שלי',
        ctaSecondary:'לראות דוגמה',
        bullets: [
          'נכתב סביב מה שהילד באמת עובר',
          'הגיבור מרגיש את מה שהילד מרגיש — ומוצא דרך',
          'לקרוא ולהאזין — הכול כלול בחבילה אחת',
        ],
      ...
      trust: {
        h2: 'אנחנו יודעים שמדובר בילד שלכם — לכן כל פרט נבנה בזהירות.',
        pillars: [
          {
            icon: '🔒',
      ...
      gallery: {
        ...
        sub: 'כל עמוד מצויר במיוחד בשבילו. סגנון חם, פרטים אישיים — והילד מגלה את עצמו בתוך הסיפור.',
      ...
      why: {
        ...
        cards: [
          ...
          { title: 'קריינות להאזנה', body: 'הסיפור מוקרא בקול שבחרתם — לקריאה משותפת, או להאזנה רגועה לפני שינה.' },
        ],
      },
      ...
      how: {
        ...
        steps: [
          ...
          { title: '✨ הספר מגיע אליכם', body: 'אחרי בדיקת איכות אנושית תקבלו קישור במייל — לקרוא ולהאזין בקורא האישי, בקצב שלכם.' },
        ],
      },
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'האם הילד באמת ייראה כמו בתמונה?',   a: 'הדמות נשענת על התמונה — גיל, שיער, גוונים, הבעת פנים כללית — אבל זה איור מותאם, לא העתק פוטוגרפי. המטרה: שיזהה את עצמו בספר, לא שייראה כמו צילום.' },
          ...
          { q: 'תוך כמה זמן הספר מוכן?',             a: 'בתקופת ההשקה אנחנו בודקים כל ספר לפני שליחה. כשהספר מוכן, נשלח לכם אימייל עם לינק לקריאה — בלי התחייבות לזמן מדויק.' },
          ...
          { q: 'מה מקבלים בפועל?',            a: 'הספר מגיע כספר דיגיטלי לקריאה והאזנה בקורא האישי — כל העמודים המאוירים, עם קריינות מלאה בקול שבחרתם. זה כלול במחיר, בלי תוספות בתשלום.' },
        ],
      },

      footer: {
        h2:               'מוכנים לתת לילד\nספר שנבנה בשבילו?',
        sub: 'דקה אחת של שאלון — וסיפור אחד שהילד יוכל להחזיק בו ברגעים הקשים.',
        cta:              'ליצירת הספר — דקה',
      },
    },
    ...
    wizard: {
      ...
      steps: {
        ...
        product: {
          title: 'בחרו סוג חוויה',
          sub:   'הכיוון קובע את אורך הספר והאווירה — בחרו את החבילה שמתאימה לכם.',
          includesLine: 'כל חבילה כוללת: ספר דיגיטלי מאויר · קריינות מקצועית',
          ctaChoose: 'לבחירה',
