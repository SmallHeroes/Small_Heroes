  ...
  he: {
    ...
    landing: {
      ...
      pricing: {
        ...
        cards: [
          {
            kicker: 'להתחלה נעימה', name: 'ספר קצר', pages: '10 עמודים', price: '50',
          ...
          {
            kicker: 'הבחירה הפופולרית', name: 'ספר בינוני', pages: '15 עמודים', price: '70',
          ...
          {
            kicker: 'החוויה המלאה', name: 'ספר מלא', pages: '20 עמודים', price: '90',
    ...
    wizard: {
      ...
      steps: {
        ...
        s8: {
          ...
          pdf:    { badge: 'מושלם כמתנה',  name: 'PDF (+₪14)',     desc: 'הורידו והדפיסו כספר פיזי' },
