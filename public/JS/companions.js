...
window.COMPANIONS_BY_CATEGORY = {
  ...
  ANGER_FRUSTRATION: [
    ...
    { id: 'lion_shaket', name: 'האריה לֵיוֹ', tagline: 'גור ביישן שמגלה שהשאגה תמיד הייתה בפנים', image: '/companions/SELF_CONFIDENCE/lion_shaket.jpg', narrativeHook: 'הקול שלך קיים — רק מחכה שתקרא לו' },
  ...
  MEDICAL_PROCEDURE: [
    ...
    { id: 'bunny_ometz', name: 'הארנבון בּוּנִי', tagline: 'ארנבון שנולד פחדן וגילה שאומץ הוא שריר שאפשר לאמן', image: '/companions/GENERAL_FEARS/bunny_ometz.jpg', narrativeHook: 'להיות פחדן לא אומר שאתה לא אמיץ' },
  ],
  OTHER: [],
};
