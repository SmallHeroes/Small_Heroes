# Story: firefly_namit_bedtime — Story Bank v5 (Hybrid: GPT-5 skeleton + Claude prose)
Generated: 2026-05-13T21:53:07.771Z
...
storyStyle: soft nocturnal emotional journey
metaphor: light that makes shadows grow
stakes: Namit runs out of light and the child is left in the dark with moving shapes
emotionalArc: active control → overwhelm → strain and doubt → dark stillness → gentle steady return
quietPage: 7
heartLine: עמוד 6 — Namit hides under a leaf, trying to glow where no one can see her flicker.
emotionalMistake: עמוד 4 — The child waves Namit closer and insists she light everything faster without noticing her strain.
uncomfortableTruth: עמוד 6 — Even when lit, one shadow stretches larger and does not shrink.
...
הצללים חוזרים אחרי שהיא עוברת.

imageDirection: Light beam hopping from coat to chair to wall, shadows shrinking then reforming behind her
...
רק קצה הזוהר שלה נראה. הצל הגבוה עדיין על הקיר.
...
--- Page 8 ---
הילד יוֹשֵׁב ליד החלון. החדר חשוך.

הצל הגבוה נשאר על הקיר. הוא לא זז.

נמית מתחת לעלה. היד של הילד קרובה.

imageDirection: Child sitting near windowsill, shadow present but still; Namit faintly visible
...
imageDirection: Soft warm pulsing light, wings relaxed, fewer sharp shadows in the room
...
imageDirection: Child lying down holding hands around Namit's gentle light, calm room with soft shadows

WORD_COUNT: [22, 24, 19, 20, 16, 20, 12, 18, 19, 20] = 190