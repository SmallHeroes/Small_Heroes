# Story: gecko_rifa_fantasy — Story Bank v5 (Hybrid: GPT-5 skeleton + Claude prose)
Generated: 2026-05-13T22:35:15.681Z
...
---
---
title: "גֵּקִי וְהַזָּנָב שֶׁנִּשְׁאַר"
...
storyStyle: gentle surreal emotional journey
metaphor: dropping parts of yourself to escape fear versus staying whole
stakes: If the child does not act, Rifa will keep shedding until she has almost nothing left and still cannot escape the fear
...
יש פה עוד חיות ביער. ארנב עם כנפי ציפור. סנאי עם אוזניים של עכבר.

אחת מהן רצה, והצבע שלה משתנה.
...
imageDirection: Rifa low to ground, body tense, eyes wide, no tail

--- Page 4 ---
אני מרים את הזנב.

הוא רך. הוא עדיין זז קצת, ואז נעצר.
...
imageDirection: birds with changing feathers, sky flickering subtly
...
imageDirection: Rifa half-turned, back arched, invisible tension at tail-stump

--- Page 8 ---
אני זז קדימה.

"רק רגע," אני אומר. "תישארי רק רגע."
...
--- Page 9 ---
צבי עובר ליד. הקרניים שלו משתנות לענפים.

ענפים חיים צומחים לו מהראש במקום קרניים.

הרעש מתקרב. חיות משנות חלקים.
...
imageDirection: Rifa hovering near tail, body curved protectively but not touching

--- Page 11 ---
אני שם את הזנב על האדמה.
...
אבל כלום לא קורה. היא לא יכולה לברוח.

היא נשארת.

imageDirection: Rifa strained and still, faint glow at tail-stump that fades

--- Page 13 ---
הרעם קרוב מאוד עכשיו.

האדמה רועדת. חיות מסביב משילות חלקים. אוזן נופלת. כנף נשברת.
...
--- Page 14 ---
אני שם את היד קרוב אליה.

לא נוגע. רק קרוב.

היא יכולה לברוח. אבל אני פה.
...
imageDirection: close-up of small repeated touch gesture
...
imageDirection: distance between Rifa and tail emphasized

--- Page 18 ---
משהו צומח בקצה הגוף שלה.
...
imageDirection: Rifa small in distance, child in foreground
...
מרחוק, חיות ממשיכות להחליף חלקים.

הכול פה ממשיך.

imageDirection: cool-toned scene, distant animals shifting, child still and thoughtful

WORD_COUNT: [26, 28, 23, 18, 22, 20, 22, 22, 24, 19, 17, 20, 23, 18, 11, 16, 15, 17, 21, 16] = 398