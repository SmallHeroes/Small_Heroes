# Story: bear_mati_bedtime — Story Bank v5 (Hybrid: GPT-5 skeleton + Claude prose)
Generated: 2026-05-14T04:57:19.005Z
...
storyStyle: quiet, intimate bedtime
metaphor: hiding in plain sight behind one's own size
stakes: Matai stays alone and unseen even when someone is right there
emotionalArc: hiding → awkward contact → rupture → being seen → gentle closeness
quietPage: 7
heartLine: עמוד 5 — Matai squeezes his huge body behind a thin sapling, trying to make himself smaller.
emotionalMistake: עמוד 3 — The child tugs Matai's scarf down abruptly to see his face.
uncomfortableTruth: עמוד 6 — The child says "I see you" plainly, and nothing bad happens, but Matai cannot hide or resolve the feeling.
...
imageDirection: bear awkwardly hiding behind rock too small, eyes lowered, child at a distance watching
...
פעם שׁתיים.
פעם שׁלושׁ.
הוא יושׁב קצת יותר גבוה.
"בסדר," הוא לוחשׁ.

imageDirection: sequence feel of scarf lowering, chin revealed, bear more upright, child smiling softly

--- Page 10 ---
הם שׁוכבים זה ליד זה.
הצעיף רפוי. הגופים נוגעים.
השׁמיים כהים.

imageDirection: intimate warm scene, child and bear touching, calm night settling, soft glow

WORD_COUNT: [23, 16, 15, 18, 19, 18, 8, 20, 21, 13] = 171