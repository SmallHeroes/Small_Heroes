# Story: bear_mati_adventure — Story Bank v5 (Hybrid: GPT-5 skeleton + Claude prose)
Generated: 2026-05-13T22:24:03.113Z
...
metaphor: hiding in plain sight through bigness
stakes: If the child does not act, Matai will remain hidden behind things forever and never be truly seen by anyone
emotionalArc: curiosity → discomfort → rupture → fragile seeing → quiet release
quietPage: 11
heartLine: עמוד 8 — Matai slowly lowers himself all the way to the ground, face hidden in his paw, making his huge body look smaller
emotionalMistake: עמוד 5 — The child loudly calls out and tries to pull Matai into the open
uncomfortableTruth: עמוד 9 — Even when nothing bad happens, Matai still cannot lift his head to be seen

--- Page 1 ---
אני רואה עקבות ענקיות על האדמה.
הן הולכות קדימה, קדימה — ואז נעצרות ליד שׂיח קטן.
מאחורי השׂיח משהו גדול מנסה להסתתר.
רק קצה צעיף חום נראה בין העלים.
...
imageDirection: Huge bear squeezed behind a narrow tree trunk, scarf covering chin, eyes down

--- Page 3 ---
אני רואה אותו.
הוא לא מסתכל עליי.
העץ לא מכסה אותו בכלל, אבל הוא נשאר שם.
הגוף שלו גדול מדי.
...
imageDirection: Matai curled behind a small rock, clearly still visible, body tense
...
imageDirection: Massive bear curled inward, scarf draped, trying to disappear into the earth
...
imageDirection: Quiet stillness, distance between them, Matai unmoving
...
imageDirection: Wide scene with distance between them, scarf visible in background, warm but quiet tone

WORD_COUNT: [28, 19, 20, 28, 21, 21, 18, 22, 17, 21, 8, 26, 18, 23, 21] = 311