# Story: snail_sheli_fantasy — Story Bank v5 (Hybrid: GPT-5 skeleton + Claude prose)
Generated: 2026-05-13T22:08:04.906Z
...
storyStyle: quiet fantasy with sensory focus
metaphor: a shell as both protection and distance from life
stakes: if the child does not adapt, Sheli will stay fully inside and miss shared moments, leaving the child alone
emotionalArc: withdrawal → cautious contact → overwhelm and rupture → fragile middle discovery → distant coexistence
quietPage: 15
heartLine: עמוד 10 — Sheli stays fully inside while a glowing flower blooms beside him, and his shell softly dims as if he feels it but cannot join.
emotionalMistake: עמוד 6 — The child taps and tries to turn Sheli's shell to force him out.
...
--- Page 4 ---
פתאום — צבעים בשמיים. פרפרים רבים עפים במהירוּת.
כנפיים בהירות ממלאות את המקום.
האנטנות נעלמות פנימה. הקונכייה נסגרת לגמרי.
כל הזוהר שלה כבה.
...
imageDirection: child leaning close, shell unmoving, other shells watching

--- Page 6 ---
הילדה מתקרבת יותר. היא מנסה להזיז את הקונכייה.
היא מקישה עליה. פעם, עוד פעם.
קונכייה אחרת מסביב מתכהה פתאום.
אחרת מתכווצת קצת.

imageDirection: shell recoiling slightly, surrounding shells dimming or frowning
...
imageDirection: child's hands hovering, shell small and withdrawn

--- Page 8 ---
רוּחַ קלה עוברת ביער.
קונכיות אחרות מזמזמות. הן לא צועקות, פשוט מרגישות את הרוּחַ.
חלקן מאירות בצבע חם.
הילדה נשארת יושבת. היא לא נוגעת.
...
imageDirection: antennae reaching out, child still and patient
...
imageDirection: half-emerged snail, antennae extended, child quietly present
...
imageDirection: child sitting still, shell partially closed, distant glowing elements
...
imageDirection: distance growing between child and shell

--- Page 18 ---
קונכיות אחרות סביב מאירות, מתכהות, מרגישות.
הן ממשיכות לחיות. העולם זז הלאה.
הילדה מסתכלת על כולן.
...
imageDirection: stillness with slight motion, unresolved posture
...
WORD_COUNT: [36, 32, 31, 26, 26, 25, 24, 23, 23, 30, 31, 26, 25, 28, 12, 28, 23, 22, 24, 28] = 523