...
- Nature metaphor: **חדר מבחן שהקירות שלו מתקרבים — כל שאלה שלא עונים עליה, הקירות זוחלים צעד פנימה** — a test room whose walls close in. Every unanswered question makes the walls move one step closer.
- companionPersonality: an eraser (מחק) who can erase ANYTHING except the questions. Panicky. "I tried! I erased the wall! It grew BACK! Let me try the floor— nope, also not working!"
- Stakes: the walls are closing — soon there won't be space to think, let alone answer
- childFirstAttempt: she tries to answer the questions as fast as possible
- childFailure: rushing makes wrong answers — wrong answers make the walls jump TWO steps
- childCost: she must stop trying to answer and instead find the EXIT — the test room has a door she didn't notice because she was focused on the questions
- solutionMode: **EXIT**
- requiredFinalAction: she looks up from the paper → sees a small door behind the teacher's chair → the eraser says "that wasn't there before!" → "it was. I just wasn't looking." → she walks past the questions (walls creak) → pushes the door → it's heavy → the eraser helps → the door opens to an open field → she walks out → the walls stop → the room remains but she's not in it → the eraser hops beside her → "the grass doesn't have questions" → "good"
- forbiddenResolution: answering all questions, walls stopping, someone opening the door for her
