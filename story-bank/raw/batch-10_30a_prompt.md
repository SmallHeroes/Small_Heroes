...
- Nature metaphor: **גשר שמחבר בין שני חדרים — חדר הילדה וחדר התינוק. הגשר שבור באמצע. כל צד מסתכל על השני אבל אף אחד לא יכול לעבור.** — a bridge between two rooms. The child's room and the baby's room. The bridge is broken in the middle. Each side can see the other but can't cross.
- companionPersonality: a spider who weaves thread but only in straight lines. Patient, methodical. "One thread at a time. Geometry doesn't rush."
- Stakes: the gap in the bridge is widening — the rooms are drifting apart
- childFirstAttempt: she tries to jump across the gap
- childFailure: it's too wide — she nearly falls, grabs the edge, pulls herself back
- childCost: patience and effort — she has to build the missing section of the bridge, plank by plank, using things from HER room (her things become the bridge)
- solutionMode: **BUILD**
- requiredFinalAction: she takes a book from her shelf → lays it across the gap → too short → adds her drawing board → getting closer → the spider weaves thread to bind them → she adds her music box (it plays as she places it) → the bridge holds → she crawls across → reaches the other side → the baby's room is warm → she sits down → the bridge is made of HER things → the spider: "not my best work, structurally. But it'll hold."
- forbiddenResolution: bridge fixing itself, rooms moving together, someone carrying her across
