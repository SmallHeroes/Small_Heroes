...
- Nature metaphor: **חוטים שעוטפים את הרגליים של הילדה ומונעים ממנה לזוז — כל "שב בשקט!" שהיא שומעת, נהיה חוט נוסף** — threads wrapping around the child's legs, stopping movement. Each "sit still!" she hears becomes another thread.
- companionPersonality: a butterfly with heavy wings who understands the desire to fly but can barely get off the ground herself. Empathetic, gentle. "I know. The air wants us but the ground holds us."
- Stakes: the threads are moving upward — if they reach her hands, she won't be able to create
- childFirstAttempt: she asks nicely to be freed (begs the threads to loosen)
- childFailure: the threads tighten when she speaks — words add tension
- childCost: she has to SNAP them with physical force — each snap stings her skin, each thread leaves a mark
- solutionMode: **FORCE**
- requiredFinalAction: she flexes her legs → one thread snaps (sting!) → she winces but keeps going → another snap → the butterfly lands on her hand to give her warmth → she STOMPS → three threads at once → legs free → she runs → the remaining threads trail behind her like streamers → they don't disappear but they're not tight anymore → the butterfly follows, barely keeping up → they run together into an open space
- forbiddenResolution: threads dissolving, someone cutting them, sitting still until they loosen
