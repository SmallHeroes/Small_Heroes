...
- Nature metaphor: **נר שהיה תמיד היחיד בחדר — עכשיו יש עוד נר, קטן, חלש, שכולם מסתכלים עליו. הנר הראשון מרגיש שהוא מהבהב פחות.** — the child was THE candle in the room. Now there's another, small, weak, that everyone stares at. The first candle feels dimmer.
- companionPersonality: a match (גפרור) who lit BOTH candles. Tired, philosophical. "I lit you BOTH. Same fire. You're not less — there's just more light now." But he only has one more strike left, so he's careful with words.
- Stakes: the first candle is flickering — if she goes out, the room will only have the new candle's weak light
- childFirstAttempt: she tries to burn BRIGHTER to get attention back
- childFailure: burning too bright makes her wax drip faster — she's consuming herself
- childCost: she has to redirect her light — instead of competing, she tilts her flame to light the dark corner that neither candle reaches
- solutionMode: **REDIRECT**
- requiredFinalAction: she tilts (scary, wax drips sideways) → her flame reaches a dark corner → the corner illuminates → things she's never seen appear there → the match whispers "look what you found" → the new candle's light + her light together fill the whole room → she's not dimmer — she's shining in a new direction
- forbiddenResolution: new candle going out, someone blowing it out, someone praising the first candle
