...
- Nature metaphor: **ראש שמלא בלונים — כל רעיון הוא בלון שמנסה לעוף, והילדה מנסה להחזיק את כולם בבת אחת. אבל ידיים מחזיקות רק כמה.** — a head full of balloons. Each idea is a balloon trying to fly. She's holding all the strings but she only has two hands.
- companionPersonality: a string-organizer octopus (just 4 arms, not 8 — he's a small octopus). Overwhelmed but willing. "Give me three! Okay four! Okay that's my limit! That one's flying away! SOMEONE HELP!"
- Stakes: if too many balloons escape, her thoughts are gone. If she holds too tight, they pop.
- childFirstAttempt: she ties all the strings to her wrist — holds everything
- childFailure: the weight lifts her off the ground — she's being carried away, losing control
- childCost: she has to ask for help — literally call out to someone (admitting she can't hold everything alone is the hard part)
- solutionMode: **ASK**
- requiredFinalAction: she calls out → "I need help holding these!" → the octopus takes some → she gives strings to a passing wind (lets some IDEAS go on purpose) → keeps only the ones she can carry → the octopus holds a few → some balloons float away but she watches them go → "those were good ideas" → "they'll come back" → she lands gently → hands lighter → the remaining balloons bob quietly above her → enough, not all → enough
- forbiddenResolution: balloons all staying, getting more arms, balloons becoming heavy
