...
- Nature metaphor: **ספר שכל פעם שפותחים אותו, האותיות עפות מהדף — הן לא נעלמות, הן מרחפות באוויר ולא רוצות לשבת** — a book whose letters fly off the page every time you open it. They don't disappear — they hover in the air, refusing to sit still.
- companionPersonality: a letter "א" who escaped long ago and lives on the windowsill. She's tiny but wise. "We don't HATE the page. We just can't SIT there. It's too... flat."
- Stakes: without letters, the book is blank — the story inside can't be read
- childFirstAttempt: she tries to catch the letters and press them back onto the page
- childFailure: pressed letters pop back out immediately — they're bouncy, giggly
- childCost: patience and creative thinking — she discovers the letters will land on MOVING surfaces
- solutionMode: **RULE_HACK**
- requiredFinalAction: she takes a spinning top → holds the book page against it → the letters are ATTRACTED to the spinning motion → they land on the spinning page → she reads WHILE spinning (dizzy, funny) → discovers she can rock the book gently (not spin) → letters settle if the page SWAYS → she reads the whole story while gently swaying the book → the א on the windowsill watches: "...nobody ever tried MOVING the page before"
- forbiddenResolution: letters sitting still, getting a different book, someone reading for her
