...
**Category:** GENERAL_FEARS (פחדים אחרים)
...
- rhythm: fast, physical, high stakes
- experienceType: energy=high, humor=light, tension=very high
- climaxType: costly_choice
- Nature metaphor: **חדר שמתמלא באבנים — כל פעם שהילדה חושבת על משהו מפחיד, אבן נופלת מהתקרה. האבנים לא כואבות אבל הן כבדות ותופסות מקום** — a room filling with stones. Each time the child thinks of something scary, a stone drops from the ceiling. They don't hurt but they're heavy and taking up space.
- companionPersonality: a strong beetle who can push small stones but not big ones. Determined, encouraging. "Another one? Fine. PUSH. We push. Come on!" Gets tired but never gives up.
- Stakes: the room is filling — soon there won't be space to stand
- childFirstAttempt: she tries to stop thinking scary thoughts (suppress them)
- childFailure: trying not to think about something makes you think about it MORE — stones fall faster
- childCost: she must PICK UP the stones (acknowledge the fears) and carry them out through the window, one by one. They're heavy. Her arms burn. Some she can barely lift.
- solutionMode: **SACRIFICE** (sacrificing comfort/the desire to avoid)
- requiredFinalAction: she grabs the biggest stone (the scariest thought) → it's freezing cold → she lifts it to her chest → staggers to the window → the beetle pushes her foot forward → she drops the stone outside → it shatters into dust → she goes back for the next one → and the next → her shoulders ache → the last stone is warm, not cold → she pauses → carries it gently → places it outside instead of dropping → room is clear → she sits down, breathing hard → the beetle sits on her knee
- forbiddenResolution: stones disappearing on their own, the room expanding, someone else clearing stones
- visibleEffect: lifting stones → carrying to window → shattering → room clearing → last stone placed gently → she sits exhausted
