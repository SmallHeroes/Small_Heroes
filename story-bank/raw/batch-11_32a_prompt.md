...
- Nature metaphor: **כיסא שמסרב לשבת — כל פעם שהילדה יושבת, הוא הופך את עצמו לנדנדה, למדרגות, לסולם. כל דבר חוץ מכיסא רגיל.** — a chair that refuses to be sat on. Every time she sits, it becomes a swing, stairs, a ladder. Anything BUT a normal chair.
- companionPersonality: a pencil who can draw, but only draws WRONG things. Asked to draw a chair? Draws a giraffe. Earnest and confused. "That IS a chair! It has four legs!" "That's a giraffe." "Same concept!"
- Stakes: school starts tomorrow and she needs to be able to SIT (the world expects sitting)
- childFirstAttempt: she holds the chair down with both hands
- childFailure: the chair transforms WHILE she holds it — she's suddenly gripping a seesaw
- childCost: instead of forcing the chair to be normal, she must BUILD an environment where the chair can be what it is
- solutionMode: **BUILD**
- requiredFinalAction: she takes the pencil → draws a desk that MOVES too → the pencil accidentally draws it perfectly (for once) → she puts the moving desk next to the moving chair → they match rhythms → she sits on the swing-chair while writing on the rocking-desk → it works → messy, weird, but functional → the pencil draws a happy face: it's a cat → "close enough"
- forbiddenResolution: chair becoming normal, getting a different chair, teacher saying it's okay not to sit
