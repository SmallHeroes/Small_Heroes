...
- Nature metaphor: **תחרות רכיבה על אופניים שבה כל הילדים הדמיוניים מהירים יותר — האופניים של הילדה הם הכי ישנים, הכי איטיים, הגלגלים חורקים** — an imaginary bicycle race where all other kids are faster. Her bike is the oldest, slowest, creakiest.
- companionPersonality: her bicycle bell — it talks. Whiny but loyal. "My spring is rusty! OIL ME! But also... keep pedaling. I like the wind."
- Stakes: she's falling further behind — if she loses, her bike might be "retired" (taken away)
- childFirstAttempt: she pedals harder, trying to catch up
- childFailure: she exhausts herself and falls further behind — the other bikes are impossibly fast
- childCost: she stops RACING and takes a different path — off the track, through the grass. She might not "win" but she'll arrive somewhere real.
- solutionMode: **EXIT**
- requiredFinalAction: she turns the handlebars LEFT → off the track → through grass (bumpy, bell screaming) → down a hill → finds a quiet meadow → stops → breathes → the bell says "...we didn't win" → she says "we went somewhere" → the other racers blur past on the track above → she sits in the grass → the bike creaks but stands → she's not last because she's not IN the race anymore
- forbiddenResolution: winning the race, getting a better bike, other kids slowing down
