...
**Category:** SIBLING (אח או אחות חדשים)
...
- Nature metaphor: **כתר הזהב שהילדה חובשת (הילדה היחידה, המיוחדת) מתחיל להתפורר כשהתינוק מגיע — זהב נושר, אבנים נופלות** — the child's golden crown (only child, special one) starts crumbling when the baby arrives. Gold flakes off, jewels fall.
- companionPersonality: a golden beetle who lives ON the crown. Dramatic, theatrical. "MY HOME! MY BEAUTIFUL HOME! It's FALLING APART!" He's more upset about the crown than the child is, which makes it funny.
- Stakes: the crown will fully crumble — and with it, her identity as "the special one"
- childFirstAttempt: she tries to glue the pieces back, holds them together
- childFailure: the glue won't hold — the crown is falling apart from the inside
- childCost: she takes the crown OFF her head and uses the gold to make something new — two small rings, one for her, one for the baby. The crown is gone but something else exists.
- solutionMode: **SACRIFICE**
- requiredFinalAction: she lifts the crown off (it's heavy, leaving a mark on her forehead) → sits on the floor → bends the gold with her fingers (it's soft, warm) → shapes one small ring → then another → the beetle watches, horrified then curious → she puts one ring on her finger → places the other by the sleeping baby → the beetle: "...it's not a crown" → "no. it's better." → the beetle settles on her ring finger
- forbiddenResolution: crown becoming stronger, baby not affecting the crown, someone giving her a new crown
