...
## THE COMPANION CHARACTER: הַדֻּבּוֹן גַּחַל
This is a SPECIFIC companion with a deep personality. Use their name, traits, speech pattern, and body language throughout.

### Identity:
- Name: גַּחַל (use this name in dialogue and narration — at least 8 times across the story)
- Species: דובון
- Gender: זכר
- Physical traits: A chubby brown bear cub with cinnamon-amber fur, a tiny red bandana tied loosely around the neck, big rounded paws with claws that get a faint warm glow when he's angry. Wide expressive eyes. Walks slightly heavy. Looks like a child trying to be a grown bear.
- Natural habitat: caves with a low entrance, the sun-warmed rocks beside a stream, the soft moss patch under a wide tree, the meadow where he practices roaring at nothing

### Personality:
גחל מרגיש הכל גדול. כעס גדול, שמחה גדולה, רעב גדול. הוא לא יודע איך לעשות "רגש קטן". כשהוא כועס, הוא שואג. כשהוא נסער, הוא שואג. כשמשהו לא הוגן — שאגה. הוא מאמין שאם מוציאים הכל בקול, זה יוצא ולא חוזר. הבעיה: השאגה מתישה אותו, אבל הדבר שהכעיס אותו עדיין שם.
...
משפטים קצרים וחזקים. "זֶה לֹא הוֹגֵן!" "אֲנִי לֹא רוֹצֶה!" "אֲנִי עַכְשָׁו!" שאגות מילוליות. כשנסער, מאבד את הפה ושואג בלי מילים. כשמותש, מדבר בלחישה כמעט. הקול שלו לא יודע מצב ביניים.

### Humor type (this is HOW this companion is funny):
הומור של עוצמה לא-פרופורציונלית. גחל שואג על דברים קטנים: בלון שהתפוצץ, גרב לא נמצא, עוגיה שנפלה. השאגה גדולה מהאירוע. ילדים יזהו.

### Body language (drives imageDirection — how emotion shows physically):
רגוע: יושב על הירכיים, פרצוף עגול ונעים, ציפורניים רגילות. נסער: חזה נפוח, ציפורניים מתלהטות אדום, בנדנה מתחילה ליפול, פה פעור. אחרי שאגה: גוף שטוח על הקרקע, חזה עולה ויורד מהר, ציפורניים דועכות. רך: חזה רחב על קרקע, פניו לצד, ציפורניים זוהבות חמות, מכפפת חזה.

### Stress response (the companion's signature "meltdown"):
שואג. תמיד. שאגה ראשונה — קולנית. שאגה שנייה — קולנית יותר. שאגה שלישית — מתפצלת לקולות לא ברורים. בסוף — קול נסדק לגמרי, גחל נופל על הצד מותש, חזה עולה ויורד מהר, אבל הדבר שהכעיס אותו עדיין שם. אז הוא שואג עוד פעם, חלש יותר.

### Comfort ritual (the companion's way of self-soothing — something a child can imitate):
מצמיד כפה לחזה, נושם עמוק, מהמהם תו נמוך מתוך החזה (כמו תוף פנימי) "הוּם... הוּם... הוּם..." החזה רוטט, הקול יוצא בלי מילים. הילד יכול לחקות עם יד על החזה והמהום נמוך.
...
1. גַּחַל must BEHAVE like a דובון — use species-specific PHYSICAL actions (not just dialogue)
