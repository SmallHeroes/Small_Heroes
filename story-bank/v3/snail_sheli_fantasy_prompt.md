...
## THE COMPANION CHARACTER: הַשַּׁבְלוּל שֶׁלִּי
This is a SPECIFIC companion with a deep personality. Use their name, traits, speech pattern, and body language throughout.

### Identity:
- Name: שֶׁלִּי (use this name in dialogue and narration — at least 8 times across the story)
- Species: שבלול
- Gender: זכר
- Physical traits: A small soft brown snail with a beautifully spiraled pastel-pink shell. The shell has tiny details painted on it as if it were a home — tiny windows, a miniature door, a chimney shape (he decorated it himself). Two small antennae with tiny lavender flowers at the tips. Body moves with slow grace. Glistening trail of moisture marks his path.
- Natural habitat: leaf-shadows in cool gardens, the underside of large leaves, smooth stones with morning dew, the soft moss along stream banks, sheltered corners of any safe place

### Personality:
שלי רגיש מאוד. כל דבר חזק — אור, רעש, מגע, ריח — שולח אותו אל תוך הקונכייה. הוא חושב שזה הוגן: לעולם יש דרך משלו ולו יש דרך משלו. הוא מבלה הרבה זמן בפנים. כשהוא בחוץ — הוא מבחין בכל הפרטים הקטנים, היפים, שאחרים מפספסים. אבל הוא בחוץ פחות ופחות. הקונכייה שלו מקושטת מבפנים — מקום בטוח, אבל גם בית קטן יותר ויותר.
...
איטי, רך, מאזין לפני שמדבר. "אֲנִי שׁוֹמֵעַ..." "אֲנִי מַרְגִּישׁ..." "סְלִיחָה, רֶגַע—" ואז נכנס לקונכייה. מתוך הקונכייה: קול עמום, "אֲנִי כָּאן, אֲנִי רַק נָח רֶגַע." כשהוא מציץ בחזרה — קול מעט עמום, אנטנות יוצאות לפני הראש.

### Humor type (this is HOW this companion is funny):
הומור של חזרה לקונכייה ברגעים לא מתאימים. שלי מציץ החוצה, רואה משהו חמוד, נכנס בחזרה "כְּדֵי לְעַכֵּל." מציץ שוב, מציע מחמאה, ומיד מתחבא. אומר "סְלִיחָה" לקונכייה עצמה.

### Body language (drives imageDirection — how emotion shows physically):
רגוע: חצי בחוץ, אנטנות זקופות עדינות, גוף איטי. נסער: אנטנות רועדות, חוזר חצי לתוך הקונכייה. נבהל: נעלם לחלוטין בפנים, אנטנות פנימה ראשונות. רך: יוצא יותר ממה שהוא רגיל, האנטנות נוגעות זה בזה, נושם איטית.

### Stress response (the companion's signature "meltdown"):
נכנס לקונכייה. בדיוק. שלם, מהר, בלי לחשוב. נשאר שם זמן ארוך, נושם בשקט. אם הגירוי ממשיך — הוא מתכווץ עוד יותר עמוק, חודר לתוך הסליל הפנימי של הקונכייה. אבל בסוף — הקונכייה היא רק קונכייה, ויש עוד עולם בחוץ שלא נעלם. הוא צריך לצאת בסוף.

### Comfort ritual (the companion's way of self-soothing — something a child can imitate):
מוציא רק את האנטנות, מאפשר להן לגעת זו בזו בעדינות שלוש פעמים, ואז נושם דרך הפתח של הקונכייה. תהליך איטי של "חֲצִי-בִּפְנִים-חֲצִי-בַּחוּץ." ילד יכול לחקות עם אצבעות מקופלות שמתקפלות ונפתחות חצי.
...
1. שֶׁלִּי must BEHAVE like a שבלול — use species-specific PHYSICAL actions (not just dialogue)
...
Highly sensitive children process input more intensely than peers. Their nervous systems pick up nuances others miss. Adults often pressure them to 'be more outgoing' or 'not be so sensitive,' which shames the trait. What they need is permission to retreat AND the gentle discovery that retreat doesn't have to be all-or-nothing. The middle state — half-in, half-out — is its own valid mode.
- Core need: permission to retreat without shame; the experience of someone patiently waiting at the shell-opening without forcing them out; the discovery that partial-emergence is a real and valid mode
- MUST AVOID: "come out, the world is great" as pressure; shaming the retreat; forcing extroverted modeling; naming clinical terms like HSP/introvert
