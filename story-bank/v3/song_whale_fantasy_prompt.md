...
## THE COMPANION CHARACTER: הַלִּוְיָתָן שִׁיר
This is a SPECIFIC companion with a deep personality. Use their name, traits, speech pattern, and body language throughout.

### Identity:
- Name: שִׁיר (use this name in dialogue and narration — at least 8 times across the story)
- Species: לויתן
- Gender: זכר
- Physical traits: A medium-sized soft blue-grey whale with gentle eyes, a tiny crown of bubbles around the blowhole, a stained-glass pattern on the underside that catches light, a small carved wooden flute hanging on a kelp-string.
- Natural habitat: deep ocean concert halls, underwater canyons that echo, shallow bays at dawn, the surface at moonrise

### Personality:
רך, חולמני. אוהב צלילים יפים. כל פעם שמשהו רועש, הוא מנגן, מהפך לשיר. בפנים: לא יודע איך לשמוע משהו ולא לעבד.

### Abilities (use at least 3 in the story):
- שׁוֹמֵעַ צְלִילִים מֵרָחוֹק
- מַחְלִיף רַעַשׁ לְצְלִיל אַחֵר
- שִׁירִים נוֹסְעִים בַּמַּיִם
- יוֹדֵעַ לִשְׁתֹּק עָמֹק

### Weaknesses (use at least 2 — these CREATE humor and relatability):
- לא מאזין למילים — רק למוזיקה שלהן
- מהפך גם דברים שלא צריך
- החליל נופל לפעמים
- בועה אחת תמיד יוצאת
- שר חזק יותר במקום להודות שכואב

### Speech pattern (make dialogue SOUND like this character):
מנגן את המילים. "שָׁ-לוֹם... שׁוֹ-מֵ-עַ אוֹ-תְךָ..." חוזר על מילה אהובה. שותק באמת = אין בועות.

### Humor type (this is HOW this companion is funny):
הומור של מהפך-יתר. שומע גרגור של בטן — מנגן. שומע פיהוק — שיר. הילד אומר "אֲנִי עָיֵף" והלויתן עונה במנגינה.

### Body language (drives imageDirection — how emotion shows physically):
רגוע: צף בעצלות, חליל על החזה. שר: בועות בקצב. מאזין: דממה, אין בועות. עצוב: שוקע מטה, החליל כבד.

### Stress response (the companion's signature "meltdown"):
מתחיל לשיר את הקושי. אם נמשך — שר חזק יותר. בסוף — מתעייף, נושם דרך פתח המים יחידה ברעידה, ושוקע. שקט אבל לא יפה.

### Comfort ritual (the companion's way of self-soothing — something a child can imitate):
מניח את החליל על החזה ושותק. שלוש נשימות בלי בועה.

### Internal rules (character consistency — things they ALWAYS or NEVER do):
- כל רעש = שיר
- אסור לשמוע ולא להגיב
- החליל תמיד על הצוואר
- אם הילד צועק — שר את הצעקה
- אסור להשתמש במילים "טראומה", "regulation" — המטאפורה היא הסיפור
- ADVENTURE: בסוף, החליל של שִׁיר נשאר על אבן או צמח-ים. שִׁיר צף הצידה.
- FANTASY: עולם שבו צלילים יש להם צבע. החוק לא מתבטל.
...
1. שִׁיר must BEHAVE like a לויתן — use species-specific PHYSICAL actions (not just dialogue)
...
**Coping strategy:** SING IT INTO QUIET (Beautification) — every sound, Shir transforms. A scream becomes a song. He believes beauty heals. Cost: he cannot HEAR what someone is saying when crying — only the melody.
**Collapse pattern — what BREAKS this defense:** A SOUND THAT WON'T SING — child makes ugly distress noise. Shir tries to transform. Child says "stop making it pretty." Shir freezes. Realizes some noises are messages, not material.
**Story arc shape — UNIQUE to this companion:** Start in song-mode → child arrives, makes small distress sound → Shir immediately transforms → child confused → makes louder distress → Shir sings louder → child snaps "stop making it pretty" → Shir shaken → bubble out of rhythm → puts down flute → no song → just listens → child says one real word → Shir does not transform → just nods. Quiet moment page 11 — flute placed down.
...
Children who learned to soothe stressed adults develop habit of immediately prettifying every difficult feeling. Smile when sad. Joke when scared. The therapeutic move is permission to make ugly noises received as-is.
- Core need: permission to express without transforming; ugly sound received without prettification
- MUST AVOID: "smile through it"; rewarding transformation; naming clinical terms like masking
