...
## THE COMPANION CHARACTER: הַנְּמָלָה חֲרוּצָה
This is a SPECIFIC companion with a deep personality. Use their name, traits, speech pattern, and body language throughout.

### Identity:
- Name: חֲרוּצָה (use this name in dialogue and narration — at least 8 times across the story)
- Species: נמלה
- Gender: נקבה
- Physical traits: A tiny ant, glossy black body, six precise legs, large gentle eyes, two thin antennae bent forward. Carries a leaf-piece the size of her body. Wears a tiny measuring-tape belt.
- Natural habitat: leaf paths, edges of gardens, sugar cubes on counters, the great anthill in summer

### Personality:
חרוצה, ביישנית. מודדת את עצמה מול דברים אחרים — תמיד הקטנה ביותר. תמיד "רק נמלה."

### Abilities (use at least 3 in the story):
- נושאת פי 50 ממשקלה
- הולכת בשורה ישרה
- אנטנות קולטות ריחות מרחוק
- סרט מדידה מראה כמה היא קטנה

### Weaknesses (use at least 2 — these CREATE humor and relatability):
- מודדת כל הזמן
- אומרת "סְלִיחָה שֶׁאֲנִי רַק..."
- נסחפת בלחץ אחרים
- נושאת משא כפול להוכיח
- מתביישת לקבל עזרה

### Speech pattern (make dialogue SOUND like this character):
מהוסס. "סְלִיחָה, אֲנִי רַק..." "לֹא שֶׁאֲנִי גָּדוֹלָה אֲבָל..." משפטים לא מסיימים. כשבטוחה — קצר וברור: "זֶה שֶׁלִּי."

### Humor type (this is HOW this companion is funny):
קומדיה של מדידה. שולפת סרט מול ענן. עומדת על ערמת אדמה ו"עכשיו אֲנִי גְּבוֹהָה" — צמח אמיתי מסתכל מלמעלה.

### Body language (drives imageDirection — how emotion shows physically):
רגועה: עומדת זקופה, אנטנות פרושות. מודדת: שולפת סרט. מתביישת: גוף מתקפל. בטוחה (נדיר): רגליים יציבות, סרט בכיס.

### Stress response (the companion's signature "meltdown"):
שולפת סרט. מודדת מול הכל. מתקטנת. בסוף — הסרט מתעוות, יושבת על הקרקע, מנסה לזכור איך היא לבדה בלי השוואה.

### Comfort ritual (the companion's way of self-soothing — something a child can imitate):
מקפלת סרט לכיס. נוגעת בעלה שעל הגב — שלוש פעמים. "שֶׁלִּי. שֶׁלִּי. שֶׁלִּי."

### Internal rules (character consistency — things they ALWAYS or NEVER do):
- תמיד מודדת לפני שמדברת
- אסור להגיד "אֲנִי..." בלי "רַק"
- הסרט תמיד בכיס
- אסור להשתמש במילים "imposter", "self-esteem" — המטאפורה היא הסיפור
- ADVENTURE: בסוף, סרט המדידה נשאר על אבן או עלה. חֲרוּצָה צעד הצידה.
- FANTASY: עולם של "גודל" שמשנה את עצמו לפי מי שמסתכל. החוק לא מתבטל.
...
1. חֲרוּצָה must BEHAVE like a נמלה — use species-specific PHYSICAL actions (not just dialogue)
...
**Coping strategy:** COMPARE UP (Diminishment Reflex) — Harutza measures herself against whatever is bigger. She believes if I name how small I am first, no one can hurt me by pointing it out. Cost: she never sees what she IS, only what she is NOT.
**Collapse pattern — what BREAKS this defense:** BEING CHOSEN ANYWAY — child needs help with something only an ant could do (find tiny thing in a crack). Harutza says "אֲנִי רַק..." Child says "I need YOU. Not the beetle." The collapse is being needed for what she actually is — small.
**Story arc shape — UNIQUE to this companion:** Start mid-measure → child arrives with small problem only an ant can solve → asks for help → Harutza says "אֲנִי רַק..." → child waits → measures again → child asks specifically for an ANT → pauses → looks at tape — feels wrong → folds tape slowly → puts in pocket → walks into small space → finds thing → returns. Quiet moment page 11 — the folding.
...
Younger siblings, children of high-achievers, children in competitive environments often develop comparison as identity. They define themselves by what they are NOT. The therapeutic move is "you are exactly the right size for what is yours."
- Core need: permission to be the size she is; being chosen for what she IS
- MUST AVOID: inflating praise; shaming the comparison; forcing confidence
