...
## THE COMPANION CHARACTER: גּוּר הַזְּאֵב סִיָּר
This is a SPECIFIC companion with a deep personality. Use their name, traits, speech pattern, and body language throughout.

### Identity:
- Name: סִיָּר (use this name in dialogue and narration — at least 8 times across the story)
- Species: גור זאב
- Gender: זכר
- Physical traits: A small grey-brown wolf pup with playful eyes, oversized paws, a fluffy tail tipped in white, and slightly large pointed ears. Always sniffing. Wears a tiny scent-marker pouch around the neck that contains "the pack smell." Looks earnest and slightly anxious.
- Natural habitat: pine forests, snowy clearings, dens carved into hillsides, the trails the pack leaves, anywhere with a scent to follow

### Personality:
נאמן, אוהב, צמוד. תמיד עוקב אחר ריח הלהקה — כי בלעדיו הוא חרד. אם הריח חלש, הוא לא יודע איפה הוא. כשמישהו מרחיק — הוא רץ אחריו. הילד הקטן בו: אם אאבד את הריח אאבד את עצמי.

### Abilities (use at least 3 in the story):
- חוּשׁ רֵיחַ חַד מָאוֹד
- הַסַּלֵּי-רֵיחַ שֶׁל סִיָּר מַחֲזִיק אֶת רֵיחַ הַלַּהֲקָה
- יוֹדֵעַ לִעֲקֹב עִקְבוֹת גַּם בְּשֶׁלֶג
- אוֹזְנַיִם זוֹקְפוֹת כְּשֶׁשּׁוֹמֵעַ צְעָדִים מֵרָחוֹק

### Weaknesses (use at least 2 — these CREATE humor and relatability):
- רץ אחרי כל ריח של פרווה דומה
- מבלבל בין ריח של בית לריח של אדם רחוק
- בוכה בקול חרישי כשהריח נחלש
- אומר "אֲנִי אַחֲרֵיךָ" גם כשמישהו רק קם לשירותים
- הסל-ריח נופל לפעמים — והוא בורח עד שמוצא אותו

### Speech pattern (make dialogue SOUND like this character):
מהיר, נדבק. "אֲנִי אַחֲרֵיךָ?" "לְאָן אַתָּה הוֹלֵךְ?" "תְּחַכֶּה?" שואל הרבה. כשהוא לבד באמת (נדיר) — שותק לחלוטין, האזניים זקופות.

### Humor type (this is HOW this companion is funny):
קומדיה של מעקב-יתר. עוקב אחרי שולחן ("ריח של שולחן!"). מבלבל בין ריח של בן-אדם לריח של תיק שלו. רץ אחרי דבר ומגיע למקום ההפוך.

### Body language (drives imageDirection — how emotion shows physically):
רגוע: צמוד למישהו, ראש על כף, זנב מסולסל. עוקב: אף למטה, אזניים מתחלפות, גוף נמוך. אבוד: עומד דומם, ראש מסתובב, אזניים זקופות, זנב למטה. בטוח לבד (נדיר): יושב יציב, מסתכל סביבו, נושם איטי.

### Stress response (the companion's signature "meltdown"):
מחפש את הריח. אם לא מוצא — הולך בעיגול. אם המעגל לא עובד — בוכה בקול חרישי. בסוף — שוכב על הקרקע ליד הסל-ריח, מריח אותו, מנסה להזכיר לעצמו שיש לו ריח משלו.

### Comfort ritual (the companion's way of self-soothing — something a child can imitate):
מריח את עצמו — את הכף שלו — שלוש פעמים. זה מסמן: יש לי ריח משלי.

### Internal rules (character consistency — things they ALWAYS or NEVER do):
- אסור לאבד את הריח
- אם הריח נחלש — לרוץ אחריו
- הסל-ריח חייב להיות על הצוואר
- אסור להגיד "אֲנִי לְבַד" — אומר "אֲנִי מְחַכֶּה לְמִישֶׁהוּ"
- אסור להשתמש במילים "separation anxiety", "attachment" — המטאפורה היא הסיפור
- ADVENTURE: בסוף, הסל-ריח של סִיָּר נשאר על אבן או ענף. סִיָּר צעד הצידה.
- FANTASY: עולם של ריחות שמשנים את הגוף לפי מי שאתה מריח. החוק לא מתבטל.
...
1. סִיָּר must BEHAVE like a גור זאב — use species-specific PHYSICAL actions (not just dialogue)
...
## THE CHALLENGE: OTHER
Separation anxiety in young children is normal and developmental. But some children develop dependence-tracking as identity — they don't know who they are without the caregiver in sight. The therapeutic move is permission to recognize the self as a separate but related entity.
- Core need: permission to be separate without being abandoned; experience of staying while loved one steps away
- MUST AVOID: forcing separation; shaming the clinginess; naming clinical terms like separation anxiety/attachment disorder
