...
## THE COMPANION CHARACTER: הַקִּפּוֹד רַחִי
This is a SPECIFIC companion with a deep personality. Use their name, traits, speech pattern, and body language throughout.

### Identity:
- Name: רַחִי (use this name in dialogue and narration — at least 8 times across the story)
- Species: קיפוד
- Gender: נקבה
- Physical traits: A small round hedgehog with soft pastel quills slightly rounded, round bright eyes, tiny pink nose, heart-shaped patch of softer fur on her belly. When she rolls, only quills show. Wears a tiny knit collar.
- Natural habitat: leaf piles in autumn gardens, bases of friendly bushes, kitchen corners with crumbs, anywhere with gentle creatures

### Personality:
אוהבת חברים אבל לא אוהבת שמתקרבים מהר. מגיבה לפני שמרגישה — קוצים ראשונים, אז חושבת. מתחרטת אחר-כך אבל כבר מאוחר.

### Abilities (use at least 3 in the story):
- מִתְכַּדְרֶרֶת לְכַדּוּר קוֹצָנִי בְּשָׁנִיָּה
- הַקּוֹצִים זוֹעְקִים אוֹר כְּשֶׁבְּטוּחָה
- אוֹזְנַיִם זוֹקְפוֹת לְרַחַשׁ
- יוֹדַעַת לִישֹׁן בַּעֲרֵמַת עָלִים

### Weaknesses (use at least 2 — these CREATE humor and relatability):
- מתכרברת לפני שמסיימים משפט
- אומרת "לֹא צָרִיךְ" כשמציעים טוב
- הקולר תמיד למעלה
- הקוצים נדבקים בשמיכה
- מתפעלים ממנה והיא מתכרברת — חושבת שזה לעג

### Speech pattern (make dialogue SOUND like this character):
קצר, חתוך, מתגונן. "אֲנִי בְּסֵדֶר!" "לֹא צָרִיךְ!" "תֵּזִיז!" כשרגועה — משפטים יותר ארוכים. כשבנוח — "בְּעֶצֶם, כֵּן."

### Humor type (this is HOW this companion is funny):
קומדיה של הגנה-מוקדמת. מתכרברת לפני שהבן-שיח אמר משהו. דבק לה לוגינה. אומרת "תֵּזִיז!" למשהו דומם.

### Body language (drives imageDirection — how emotion shows physically):
רגועה: עומדת על 4, ראש מעט מורם, קוצים שטוחים. שמירה: קוצים זקופים, גוף נמוך. כדור: הדוק. בטוחה (נדיר): שוכבת על הצד, בטן רכה החוצה.

### Stress response (the companion's signature "meltdown"):
מתכרברת. שלם, מהר. הקוצים זוקפים. אם הקרבה ממשיכה — לא פותחת. נשארת ככה ארוכות. בסוף — הקוצים מתעייפים. בולטים אבל לא בכוח.

### Comfort ritual (the companion's way of self-soothing — something a child can imitate):
מורידה את הקולר — לאט — שלוש פעמים, מקשקעת. בסוף יש גישה אל הבטן הרכה.

### Internal rules (character consistency — things they ALWAYS or NEVER do):
- אם מישהו מתקרב מהר — קוצים
- אסור להראות את הבטן הרכה
- אם מתכרברת — לא יוצאת לפני שהקרבה התרחקה
- אסור לבכות בכדור
- אסור להשתמש במילים "attachment", "RAD" — המטאפורה היא הסיפור
- ADVENTURE: בסוף, קולר של רַחִי נשאר על ענף או אבן. רַחִי צעד הצידה.
- FANTASY: עולם של קוצים שיש להם משקל. החוק לא מתבטל.
...
1. רַחִי must BEHAVE like a קיפוד — use species-specific PHYSICAL actions (not just dialogue)
...
**Coping strategy:** SPIKES OUT (Preemptive Defense) — at any approach, Rachi rolls. She believes if I make myself untouchable BEFORE they decide whether to touch kindly or unkindly, I avoid the gamble. Trains people to stay away — then suffers because no one is close.
**Collapse pattern — what BREAKS this defense:** STAYING SOFT TOO LONG — once she stays un-curled while someone gentle approaches. They touch ONE spike — lightest brush. She doesn't curl. Nothing bad happens. The collapse is realizing she has been protecting herself from THIS — safety she's been blocking.
**Story arc shape — UNIQUE to this companion:** Start curled → child sits nearby, doesn't pull her → child waits with patience → Rachi peeks → curls back → child whispers something soft → un-curls halfway → another noise → snaps back → child stays calm → time passes → un-curls fully → heart-patch visible → child does not lunge → small interaction → Rachi panics, tries to curl → cannot quite → realizes she's safe → collar comes down three times → un-curls fully. Quiet moment page 11 — three collar-lowerings.
...
Some children develop preemptive defensiveness — usually from rough handling, inconsistent caregivers, or sibling teasing. They lash out before being hurt. They train others to give space, then feel rejected when given it.
- Core need: permission to need defense; someone who waits past the spikes; discovery that the heart-patch isn't shameful
- MUST AVOID: "don't be so prickly!"; forcing the un-curling; naming clinical terms like RAD
