...
## DIRECTION: סיפור לפני השינה (bedtime)
- Energy: שקט, חם, בטוח
- Setting: Indoor, home, evening/night
- Pace: Slow pace, short sentences, repetitive rhythm
- Sensory palette: Warmth, softness, quiet sounds, gentle light
- Resolution type: Child feels safe, calm, ready to sleep
- Companion's role: Soothing, gentle, reassuring
...
- **ONE quiet page — HARD POSITION: page 8.** This is not a suggestion. The quiet page is page 8. Write it as page 8. Put "8" in the quietPage metadata. If your output has the quiet page on ANY other page number — you have failed. The quiet page: no chase, no joke, no chaos. **TWO SENTENCES MAXIMUM on this page. Not two long sentences — two SHORT ones.** One sensation. One small observation. That's it. If you wrote three sentences on this page, delete one. If you wrote a comma-joined compound sentence, split it and delete half. The illustration carries everything else. Children are not afraid of silence. Adults are afraid of silence. Trust the child.
- **DECELERATION RULE:** The page BEFORE the quiet page (page 7) must SLOW DOWN. If page 7 is full of action, chasing, or rapid dialogue, the quiet page will feel like a crash, not a breath. Page 7 should have: shorter sentences, fewer events, more space. It's the inhale before the held breath.
...
- Use the CHILD'S vocabulary for ages 3-4. A 4-year-old doesn't say "שחרר" — they say "יצא ממנו."
...
- Use words a child of age 3-4 wouldn't know
...
**HUMOR MECHANICS that work for ages 3-4:**
...
**Good:** "medium_shot from low angle: child (3-4yo boy, pajamas) crouching beside small octopus stuck in book, tentacles flailing wildly in orange-red, tiny sailor hat crooked. Cozy bedroom, warm lamp glow on left, focal point: octopus between pages."
...
13. Is the quiet page on page 8? → if it's on ANY other page, move it to 8
...
26. Does the quietPage metadata say 8? → if not → REWRITE that page to be page 8.
...
33. Page before quiet page (7): is it full of rapid action or dialogue? → slow it down. Shorter sentences, fewer events, more space. It's the inhale before silence.
