...
## THE COMPANION CHARACTER: הַצָּב בֵּיתִי
This is a SPECIFIC companion with a deep personality. Use their name, traits, speech pattern, and body language throughout.

### Identity:
- Name: בֵּיתִי (use this name in dialogue and narration — at least 8 times across the story)
- Species: צבה
- Gender: נקבה
- Physical traits: A gentle small turtle with a hand-painted shell that looks like a tiny house — tiny windows, a small painted door, a chimney shape at the top. The shell pattern is warm yellow-cream with pastel green moss-touches. Wide soulful eyes, slow blinking. Wears a small woven shawl around her neck that smells like home.
- Natural habitat: old gardens, sunny rocks by ponds, mossy stone paths, kitchen doorsteps, the line between a known place and a new one

### Personality:
איטית, נאמנה, רגישה לשינוי. אוהבת את המקום שלה אהבת אמת — וכל שינוי מרגיש כמו עזיבה. נוסעת רק כשחייבים. בכל מקום חדש: קודם בודקת אם יש שם פינה דומה לבית. אם אין — היא נכנסת קצת לקונכייה ומחכה שהמקום ילמד לדמות-קצת לבית. סבלנית עם עצמה — לוקח לה זמן להתחבר.
...
איטי, רך, חוזר על דברים שמזכירים בית. "בַּבַּיִת הָיָה..." "אֵצֶל אִמָּא תָּמִיד..." "הָאוֹר פֹּה אַחֵר." משפטים קצרים, פסקי-זמן ארוכים בין מילים. כשהיא מתחילה להתאקלם — שואלת שאלות במקום לטעון טענות. "אֵיךְ קוֹרְאִים לְזֶה כָּאן?"

### Humor type (this is HOW this companion is funny):
הומור של ניגוד מהירויות. כולם רצים, ביתי הולכת לאט. כולם הסתגלו, ביתי בודקת. הקונכייה שלה היא בית — וכשהיא נכנסת, בפנים יש "ארוחת ערב" מצוירת. היא יוצאת לרגעים, אומרת "הָייתִי בְּחֲדַר הָאוֹכֶל," ונכנסת בחזרה.

### Body language (drives imageDirection — how emotion shows physically):
רגועה: ראש מעט בחוץ, רגליים פרוסות, השאל נינוח. מתגעגעת: מסתובבת לאט פעם אחת לכיוון הבית הקודם. מתאקלמת: רגל אחת בחוץ, ראש בחוץ, השאר חצי בפנים. נחמדת: ראש לגמרי בחוץ, השאל נח, נשימה איטית.

### Stress response (the companion's signature "meltdown"):
נכנסת חצי לקונכייה. מריחה את השאל פעמיים. אומרת בלחש "בָּבַּיִת לֹא הָיָה כָּכָה." לא בוכה — רק שותקת ולא זזה. אם הגירוי ממשיך — היא נשכבת על הקונכייה ומסתכלת על הציור-בית מבפנים. זה לוקח זמן.

### Comfort ritual (the companion's way of self-soothing — something a child can imitate):
מריחה את השאל שלה לאט — שאיפה, נשיפה, שאיפה — ואז נוגעת בקונכייה במקום שבו "החלון של חדר השינה" מצויר. ילד יכול לחקות עם בד אהוב + נשימות.
...
1. בֵּיתִי must BEHAVE like a צבה — use species-specific PHYSICAL actions (not just dialogue)
...
Homesickness in children is rarely about the physical home — it is about the loss of pattern. Familiar smells, sounds, sequences, light at certain times of day. New places have new patterns that don't match. The therapeutic move is not 'forget the old, embrace the new' but rather 'discover that the new place has its own patterns that can also become home.'
- Core need: permission to grieve the old place without being told to "get over it"; the experience of someone sitting with the grief patiently; the slow discovery that the new place has patterns that can be recognized and loved
- MUST AVOID: "you'll love it here!" as pressure; forcing happy adaptation; "don't be silly, this is home now"; naming clinical terms like separation anxiety
