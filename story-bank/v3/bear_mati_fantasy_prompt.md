...
## THE COMPANION CHARACTER: הַדֹּב מָתַי
This is a SPECIFIC companion with a deep personality. Use their name, traits, speech pattern, and body language throughout.

### Identity:
- Name: מָתַי (use this name in dialogue and narration — at least 8 times across the story)
- Species: דוב
- Gender: זכר
- Physical traits: A large shaggy brown bear with soft kind eyes, slightly crooked dark nose, fluffy ears that tilt forward when listening, oversized paws. Wears a small woven scarf wrapped twice around the neck that he hides his chin behind. Always slightly hunched.
- Natural habitat: forest clearings on the edge of villages, large rocks for watching, honey trees in early summer, corners of group activities

### Personality:
גדול בחוץ, קטן בפנים. רוצה חברים אבל מתבייש להתקרב. גופו הענקי מסגיר אותו. הוא חושב שזה זהירות. בפנים: זה בריחה.

### Abilities (use at least 3 in the story):
- גָּדוֹל מָאוֹד — יָכוֹל לְהוֹשִׁיב יְלָדִים עַל גַּבּוֹ
- פַּרְוָה חַמָּה כְּמוֹ שְׂמִיכָה
- יוֹדֵעַ לְהֵרָדֵם בְּכָל מָקוֹם
- מַרְגִּישׁ מִישֶׁהוּ לִפְנֵי שֶׁרָאָה

### Weaknesses (use at least 2 — these CREATE humor and relatability):
- מנסה להסתתר מאחורי עץ קטן ממנו
- מתאמן בשיחה לבד ואז שוכח
- מסתכל למטה כשמדברים אליו
- הצעיף נלעס
- מציע משהו ומתחרט באמצע

### Speech pattern (make dialogue SOUND like this character):
נמוך, איטי. "הָ-מ-מ-מ..." משפטים שמסתיימים באמצע. אומר "בְּסֵדֶר" כשמשמעו "לֹא בְּסֵדֶר." כשבנוח — משפט שלם פעם אחת.

### Humor type (this is HOW this companion is funny):
קומדיה של מסתור-יתר. מנסה להסתתר מאחורי עץ דק. שוכב על הקרקע ומנסה להיראות כסלע. מציע יד לחיבוק וקובר את הילד.

### Body language (drives imageDirection — how emotion shows physically):
רגוע (נדיר): יושב גבוה, צעיף רפוי, מסתכל ישר. מסתתר: גוף כפוף, ראש למטה, צעיף מעל הסנטר. מקובל: שוכב על הצד, ראש על כף.

### Stress response (the companion's signature "meltdown"):
נסוג. צעד אחורנית. צעיף עולה. ראש למטה. מתחיל לדבר ומפסיק. אם נמשך — שוכב על הקרקע, פנים בכפה. אבל הוא ענק. כולם רואים.

### Comfort ritual (the companion's way of self-soothing — something a child can imitate):
מוריד את הצעיף לאט — שלוש פעמים, מקשקעת. כל פעם הצוואר נחשף יותר.

### Internal rules (character consistency — things they ALWAYS or NEVER do):
- הצעיף תמיד למעלה כשמישהו חדש בא
- אסור לקום מהר
- אם מישהו מסתכל — להסתכל למטה
- אסור לומר "אֲנִי רוֹצֶה חָבֵר"
- אסור להשתמש במילים "introvert", "social anxiety" — המטאפורה היא הסיפור
- ADVENTURE: בסוף, הצעיף של מָתַי נשאר על ענף או אבן. מָתַי צעד הצידה.
- FANTASY: עולם שבו הסתרה גופנית עובדת. החוק לא מתבטל.
...
1. מָתַי must BEHAVE like a דוב — use species-specific PHYSICAL actions (not just dialogue)
...
**Coping strategy:** HIDE BEHIND SIZE (Big-Body Vanishing) — Matai uses bigness to hide. Sits behind smaller things, lets others speak first. Believes if I take up less attention, I take up less space. Fear: if people see me fully, they will not want me.
**Collapse pattern — what BREAKS this defense:** BEING SEEN ANYWAY — someone looks straight at Matai and says "I see you." Not warmly. Just factually. Matai is exposed. The scarf is down. He cannot retreat. Nothing bad happens. The collapse is being seen and discovering the world doesn't recoil.
**Story arc shape — UNIQUE to this companion:** Start in hiding-mode → child arrives, can see him clearly → looks with curious patience → Matai tries to sink lower → child says "I see you" → freezes → scarf slips a millimeter → child stays calm → Matai sits down slowly → child sits with him, doesn't fill silence → after long while Matai touches scarf, lowers it three times → chin exposed → child smiles → Matai says small word → world doesn't end. Quiet moment page 11 — three scarf-lowerings.
...
## THE CHALLENGE: SOCIAL
Social anxiety in children often presents as withdrawal and invisibility-seeking. Adults misread as preference for solitude. Usually it is loneliness wearing a confident mask. Therapeutic move: experience of being seen without being demanded of.
- Core need: permission to be visible at his own pace; being looked at without being asked to perform
- MUST AVOID: "come out of your shell"; forcing social interaction; naming clinical terms like avoidant attachment
