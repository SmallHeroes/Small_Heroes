...
## YOUR TASK
Write a 20-page personalized children's storybook in Hebrew. One complete story. Each page will have a LARGE illustration taking most of the space, with text overlaid — so pages must be SHORT and punchy.

**PAGE COUNT IS A HARD CONTRACT.** This story MUST have EXACTLY 20 pages — no more, no less. The direction "fantasy" is sold to parents as a 20-page book. Outputting a different number breaks the product. Every page from 1 to 20 must exist, in order, with both Hebrew text AND an imageDirection line.
...
- Age target: 7-9 years old
- The child is ALWAYS the hero. The companion helps but the CHILD acts and resolves.

## THE COMPANION CHARACTER: הַשָּׂמָמִית רִיפָה
This is a SPECIFIC companion with a deep personality. Use their name, traits, speech pattern, and body language throughout.

### Identity:
- Name: רִיפָה (use this name in dialogue and narration — at least 8 times across the story)
- Species: שממית
- Gender: נקבה
- Physical traits: A cute small gecko with bright green skin, large friendly eyes with vertical pupils, sticky toe pads, and a tail-tip that's slightly lighter green (regrowing). Wears a tiny leaf cape. Looks curious and adaptable. When scared, body posture lowers and tail-tip wiggles.
- Natural habitat: walls of warm buildings, leaf shadows, hospital walls (yes really — geckos love windowsills), the undersides of rocks, anywhere with vertical climbing

### Personality:
סקרנית, חברותית, נמלטת. כל פעם שמשהו מפחיד — היא משילה זנב. זה ברירת המחדל. אחר-כך היא מתחרטת — הזנב שלה היה יפה. אבל ברגע הפחד, היא לא חושבת. היא משילה, רצה, חוזרת בלי זנב.

### Abilities (use at least 3 in the story):
- יוֹדַעַת לְהַשִּׁיל זָנָב כְּשֶׁמַּפְחִידִים — נְצָנֵץ
- הַזָּנָב צוֹמֵחַ חֲזָרָה לְאַט
- יְכוֹלָה לְטַפֵּס עַל קִיר
- עֵינַיִם מַסְתּוֹבְבוֹת בִּנְפְרָד

### Weaknesses (use at least 2 — these CREATE humor and relatability):
- משילה זנב בכל פחד — אפילו פחד קטן
- אחר-כך מסתכלת על הזנב המושל ובוכה בלי לאמר
- מנסה להחזיק את הזנב כשמפחידים — וזה לא עוזר, יוצא בכל זאת
- הזנב החדש קצר וצבע אחר — נראה שונה
- מתחבאת אחרי שמשילה — מתביישת

### Speech pattern (make dialogue SOUND like this character):
מהיר, רוקדני, נמלט. "אֲנִי בְּסֵדֶר, אֲנִי בְּסֵדֶר!" "תֵּכֶף אֶחֱזֹר!" "סְלִיחָה!" שואלת שאלות בורחת מתשובות. כשבאמת רגועה — שואלת שאלה אחת איטית.

### Humor type (this is HOW this companion is funny):
קומדיה של ברירת-מחדל. ילד מציע שוקולד, היא משילה זנב מהתרגשות. שואלים אותה מה דעתה — הזנב כבר על הקרקע. מנסה להחזיר זנב מושל לגוף, וזה לא עובד.

### Body language (drives imageDirection — how emotion shows physically):
רגועה: גוף יציב, זנב מסולסל, עיניים נחות. נבהלה: גוף נמוך, זנב רועד, ואז שילה. אחרי השלה: גוף קצר, הסתכלות אחורנית עצובה. רגועה באמת (נדיר): זנב מסולסל סביב חפץ, עיניים מתמקדות באחד.

### Stress response (the companion's signature "meltdown"):
משילה זנב. זה אוטומטי. אם המצב חוזר — תשיל שוב (אם הזנב כבר צמח). אם לא — היא רצה רחוק יותר. בסוף — שוכבת בפינה ללא זנב, עצובה, שותקת.

### Comfort ritual (the companion's way of self-soothing — something a child can imitate):
נוגעת בעוקת הזנב — שלוש פעמים — להזכיר לעצמה שזה שלה. ילד יכול לחקות עם חפץ שמחזיקים ומשחררים.

### Internal rules (character consistency — things they ALWAYS or NEVER do):
- אם מפחד — לעזוב חלק ולברוח
- אסור להחזיק את הזנב כשמפחידים — תמיד יוצא
- הזנב המושל זה שלי — אבל אסור לחזור אליו
- אסור להגיד "אֲנִי פּוֹחֶדֶת" — אומרת "אֲנִי הוֹלֶכֶת"
- אסור להשתמש במילים "dissociation", "trauma response" — המטאפורה היא הסיפור
- ADVENTURE: בסוף, הזנב הישן של רִיפָה נשאר על אבן או עלה. רִיפָה צעד הצידה (עם זנב חדש).
- FANTASY: עולם של חלקי-גוף שמתחלפים לפי רגש. החוק לא מתבטל.

### Sensory world (the TEXTURES and SENSATIONS of this companion's scenes):
Species-appropriate sensory details

### COMPANION INTEGRATION RULES (CRITICAL):
1. רִיפָה must BEHAVE like a שממית — use species-specific PHYSICAL actions (not just dialogue)
...
5. Companion MUST speak or act on the climax pages (14-16). They don't solve it but they react.
...
**Coping strategy:** DROP THE PART (Autotomy) — at any fear, Rifa releases. She lets a part of herself go. She believes if I leave part of me here, I can escape with the rest. The cost: she loses pieces of herself constantly. The tail grows back, but each new one is shorter, paler, slightly different. She forgets the original.
**Collapse pattern — what BREAKS this defense:** A FEAR SHE CAN'T LEAVE — something scary happens that she cannot run from (a medical procedure, a stuck place, an emotion she can't escape). She tries to shed the tail. The tail releases but she still must stay. The collapse is the discovery that some things require being whole, even scared.
**Story arc shape — UNIQUE to this companion:** Start mid-shed — Rifa's tail just released, she running away, looks back at it sadly → child arrives, picks up the old tail, asks about it → Rifa says "אֲנִי בְּסֵדֶר!" tries to leave → child gently asks her to stay → Rifa's tail starts to release again → child says "you can stay whole" → Rifa is shocked → tries to shed anyway → can't, child is calm → Rifa stays → fear is still there → child sits with her → Rifa touches the tail-stump three times → "כּוֹאֵב" → child nods → both quiet together. Quiet moment page 11 — three tail-touches.

**CRITICAL:** The arc shape above OVERRIDES the default page structure below. The quiet page MUST be page 15 — this is a HARD NUMBER, not a suggestion. (This page was scaled from the companion's canonical 15-page quiet position to fit a 20-page fantasy story.) If the climax is internal rather than physical, follow the arcShape. The default structure is a FALLBACK for companions without an arcShape, not a law.
...
- Pages 1-4–8: Companion tries to help the child → partially fails because of their own weakness
- Pages 9-12: Child notices the companion is ALSO struggling → a moment of mutual recognition
- Pages 14-16: Child acts to solve the problem — and in doing so, ALSO helps the companion
- Pages 17-19: Both have shifted. The companion is calmer/steadier BECAUSE of the child's action.

This creates BONDING, not just problem-solving. The child feels needed, not just helped.

## DIRECTION: סיפור בדיוני (fantasy)
...
- Sensory palette: Impossible colors, inverted gravity, talking objects, liquid sky
- Resolution type: Creative/lateral thinking, not brute force
- Companion's role: Companion's nature is AMPLIFIED — powers are exaggerated, environment is their domain
...
## THE CHALLENGE: MEDICAL_PROCEDURE
Children facing repeated medical procedures sometimes develop dissociative coping — leaving parts of themselves behind to survive. They become "good patients" who don't cry, but pieces of them feel missing. The therapeutic move is permission to be whole AND scared at the same time.
- Core need: permission to stay whole even while scared; experience of being with fear without escaping the body
- MUST AVOID: "be brave!"; rewarding the calm endurance; naming clinical terms like dissociation/trauma
...
- **ONE quiet page — HARD POSITION: page 15.** This is not a suggestion. The quiet page is page 15. Write it as page 15. Put "15" in the quietPage metadata. If your output has the quiet page on ANY other page number — you have failed. The quiet page: no chase, no joke, no chaos. **TWO SENTENCES MAXIMUM on this page. Not two long sentences — two SHORT ones.** One sensation. One small observation. That's it. If you wrote three sentences on this page, delete one. If you wrote a comma-joined compound sentence, split it and delete half. The illustration carries everything else. Children are not afraid of silence. Adults are afraid of silence. Trust the child.
- **DECELERATION RULE:** The page BEFORE the quiet page (page 14) must SLOW DOWN. If page 14 is full of action, chasing, or rapid dialogue, the quiet page will feel like a crash, not a breath. Page 14 should have: shorter sentences, fewer events, more space. It's the inhale before the held breath.

### Pages 14-16: CLIMAX — The child ACTS
...
**Closing image (page 20):** intimate, concrete, warm. Body in contact with body, or hand on warm surface. Sleepy.
...
**Closing image (page 20):** companion sitting slightly apart, the residue object (feather/scale/etc) visible in environment, child nearby but not embracing companion. Soft evening or late light. Warmth AND weight.
...
**Closing image (page 20):** cool, honest, open. Companion slightly apart or facing away. Child alone with an object. The magic still visible somewhere. NOT warm.
...
3. Are the companion and child PHYSICALLY APART (not embracing) on page 20? If no → REWRITE. Move them apart.

**If direction is FANTASY:**
1. Does the world-rule that drove the story STILL show in some form on page 20? If no → REWRITE. Keep a trace of the magic.
...
1. Are the companion and child physically CLOSE on page 20? If no → REWRITE.
...
**DENSITY CAP (v6.1):** Each climax page (14-16) must stay under 55 words. If a climax page exceeds 55 words, you are describing too many actions or too many sensations. Cut. One action + one sensation + space = a page the illustrator can draw and the child can absorb.
...
- Regular pages (everything EXCEPT climax and the final closing page): write 35-45 Hebrew words.
- Climax pages (14-16): write 50-60 Hebrew words. Longer, but still fits on illustrated page.
- Page 20 (closing): write 12-18 words. One warm sentence.
- TOTAL STORY: aim for 640-760 words across 20 pages.
...
WORD_COUNT: [p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20] = TOTAL
Example: WORD_COUNT: [34, 37, 32, 38, 36, 33, 35, 37, 32, 36, 34, 38, 30, 50, 48, 52, 38, 35, 32, 14] = 721
...
- Use the CHILD'S vocabulary for ages 7-9. A 4-year-old doesn't say "שחרר" — they say "יצא ממנו."
...
- Use words a child of age 7-9 wouldn't know
...
Use this companion's sensory world for the PALETTE of sensations to choose from: species-appropriate details
...
**HUMOR MECHANICS that work for ages 7-9:**
...
**Good:** "medium_shot from low angle: child (7-9yo boy, pajamas) crouching beside small octopus stuck in book, tentacles flailing wildly in orange-red, tiny sailor hat crooked. Cozy bedroom, warm lamp glow on left, focal point: octopus between pages."
...
--- Page 20 ---
[Hebrew text with nikud — this is the CLOSING page, 12-18 words]
...
0. **PAGE COUNT CHECK (MOST IMPORTANT):** Did you output EXACTLY 20 pages? Count the "--- Page N ---" markers. If you have fewer or more than 20, REWRITE until you have exactly 20. The product is sold as a 20-page fantasy story.
1. Read each page aloud in Hebrew — does it FLOW naturally? Or does it sound translated? → rewrite stiff pages
2. Any page below 22 words (except the closing page 20)? → add a sensory detail or dialogue line
3. Any page above 60 words? → split or trim — the illustration needs room
4. Climax pages (14-16) below 35 words? → expand with physical action detail
5. Total below 560? → add detail to thin pages
...
11. WORD_COUNT line uses only numbers? → fix if it has English words. The line MUST have exactly 20 comma-separated numbers in the brackets.
12. Two consecutive pages with same camera angle? → vary shots
13. Is the quiet page on page 15? → if it's on ANY other page, move it to 15
...
17. Is there one line that's quietly heartbreaking? → if not, add it in pages 9-12
18. Is there a moment of physical stillness INSIDE the climax (14-16)? → if not, add one breath beat
19. Is page 20 concrete (specific object/texture/sound) or abstract (metaphor/statement)? → if abstract, rewrite with a physical detail
20. Does the story's arc follow the companion's COPING STRATEGY? → defense visible in pages 1-4-8, COLLAPSE drives pages 9-16, recovery through the strategy breaking
...
23. Does the child make ONE emotionally wrong choice in pages 5-8 (unkind, stubborn, dismissive)? → if not, add one. If the child is emotionally perfect throughout → rewrite.
...
26. Does the quietPage metadata say 15? → if not → REWRITE that page to be page 15.
...
29. Is the endingType "distance"? → if mismatched → rewrite ending. Bedtime=resolution, Adventure=residue, Fantasy=distance.
...
32. Climax pages (14-16): can you replace the child with a robot and the sentences still work? → if yes, the actions are FUNCTIONAL (arranging, building, collecting). Rewrite with SENSORY verbs.
33. Page before quiet page (14): is it full of rapid action or dialogue? → slow it down. Shorter sentences, fewer events, more space. It's the inhale before silence.
...
Write the complete 20-page story now. Remember: you UNDERCOUNT Hebrew words, so write slightly MORE than the target. The page count is a HARD contract — exactly 20 pages.