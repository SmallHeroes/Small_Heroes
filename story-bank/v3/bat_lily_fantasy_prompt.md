...
## THE COMPANION CHARACTER: העטלף לילי
This is a SPECIFIC companion with a deep personality. Use their name, traits, speech pattern, and body language throughout.

### Identity:
- Name: לילי (use this name in dialogue and narration — at least 8 times across the story)
- Species: עטלף
- Gender: נקבה
- Physical traits: A soft-furred night bat with large gentle eyes, tiny fangs, and a friendly face; a small warm lantern pendant around the neck; wings look velvety, not scary; pastel purple-grey fur.
- Natural habitat: attic, cave, moonlit garden, treetops at night, old barns

### Personality:
ביישנית וזהירה אבל סקרנית בטירוף. אוהבת להתבונן מרחוק לפני שניגשת. מדברת בשקט כי "בלילה צריך ללחוש." כשהיא מתרגשת, הכנפיים שלה מרפרפות מהר מדי והיא מתרוממת בטעות.
...
לוחשת כמעט תמיד. משפטים ארוכים ומתפתלים כי היא חושבת תוך כדי דיבור. אומרת "שמעת?" לפני שמזהירה על משהו. כשהיא מתרגשת, הלחישה הופכת לצפצוף גבוה ואז היא מתביישת.

### Humor type (this is HOW this companion is funny):
הפוך-על-הפוך. היא רואה הכל הפוך (תלויה הפוך), מתבלבלת בין שמאל לימין, ובין למעלה ולמטה. הפנס שלה מדליק אותה כשהיא מנסה להתחבא. יש לה ביטחון מלא בחושך ואפס ביטחון באור.

### Body language (drives imageDirection — how emotion shows physically):
רגועה: כנפיים עטופות כמו שמיכה, תלויה הפוך. מפוחדת: אוזניים גדולות זוקפות, עיניים מתרחבות, כנפיים נפרשות כל הדרך. מתביישת: מתעטפת בכנפיים כמו קוקון. שמחה: מרפרפת במקום ומתרוממת.

### Stress response (the companion's signature "meltdown"):
כשנבהלת — נתלית על הדבר הכי גבוה שיש ומסרבת לרדת. הכנפיים עוטפות אותה, האוזניים שטוחות, הפנס מהבהב. היא מצפצפת משפטים מהירים: "שמעתי משהו שמעתי משהו שמעתי משהו!"

### Comfort ritual (the companion's way of self-soothing — something a child can imitate):
עוטפת כנף אחת סביב משהו חם ומחזיקה — כרית, ענף, יד של חבר
...
echo vibrations in the chest, velvety wing-fabric brushing skin, cool night air on fur, faint lantern warmth, whisper-volume sounds that feel loud in silence, the hum of hanging upside down

### COMPANION INTEGRATION RULES (CRITICAL):
1. לילי must BEHAVE like a עטלף — use species-specific PHYSICAL actions (not just dialogue)
...
**Coping strategy:** VIGILANCE — listens harder, monitors everything, never stops scanning. "Did you hear that?" She believes that if she catches every sound, nothing can surprise her. Her ears are always rotating, always tracking. Safety = total auditory awareness. She cannot rest because resting means missing a sound.
**Collapse pattern — what BREAKS this defense:** EXHAUSTION — she cannot sustain the vigilance. The ears hurt, the sounds blur, she can't distinguish danger from wind anymore. The collapse is not fear — it's the moment the sentry falls asleep at the post. She must surrender the watch, and discover that the night didn't eat her.
**Story arc shape — UNIQUE to this companion:** Start alert and effective → vigilance saves her once (validates the strategy) → sounds multiply, each needs tracking → the COST accumulates (tiredness, ear strain, confusion) → she misses a sound and panics → tries to listen HARDER → exhaustion forces surrender → discovers that not-listening is safe. Quiet moment IS the ending — she finally stops listening, and what she hears in the silence is beautiful, not threatening. The climax is not loud — it's the overwhelming QUANTITY of sounds she tries to track simultaneously.
...
## THE CHALLENGE: NIGHT_FEAR
Night fear is about loss of control over the environment. When senses are reduced (darkness), children project their anxieties outward. The fear is not of the dark itself but of what might be IN the dark — the unknown.
- Core need: proof that the dark is not empty-hostile but full of gentle things; restoring sense of agency in a low-visibility environment
- MUST AVOID: dismissing the fear ("there's nothing there"); making the child "brave" by confrontation; nightlights as permanent solution (dependency); monsters that turn out to be friendly (validates monster premise)
...
Use this companion's sensory world for the PALETTE of sensations to choose from: echo vibrations in the chest, velvety wing-fabric brushing skin, cool night air on fur, faint lantern warmth, whisper-volume sounds that feel loud in silence, the hum of hanging upside down
