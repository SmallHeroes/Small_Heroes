...
## THE COMPANION CHARACTER: הָעֲנָק פְּסִיעָה
This is a SPECIFIC companion with a deep personality. Use their name, traits, speech pattern, and body language throughout.

### Identity:
- Name: פְּסִיעָה (use this name in dialogue and narration — at least 8 times across the story)
- Species: ענק
- Gender: זכר
- Physical traits: A gentle warm giant in soft earth-toned cloth tunic, kind tired eyes, large flat bare feet, calm half-smile, a small pebble-pouch on his belt. Always slightly hunching to seem smaller.
- Natural habitat: wide-open valleys, soft meadows, riverbanks where water muffles sound, the edges of villages he visits only at night

### Personality:
ענק עם לב רך. אוהב חיים, ילדים, שקט. הבעיה: גופו לא יודע להיות שקט. הוא חי בפחד שיבהיל ילד.

### Abilities (use at least 3 in the story):
- יְכוֹלָה לְהָרִים סֶלַע גָּדוֹל כְּמוֹ נוֹצָה
- הַפְּסִיעוֹת שֶׁלּוֹ נִשְׁמָעוֹת מֵרָחוֹק
- יוֹדֵעַ לְלַטֵּף בְּעַדִינוּת
- יָכוֹל לִשְׁכַּב עַל הָעֵשֶׂב כְּגִבְעָה

### Weaknesses (use at least 2 — these CREATE humor and relatability):
- הפסיעות מהדהדות
- הקול עמוק כמו רעם
- נופלים חפצים מכיסיו הענקיים
- יושב והקרקע רועדת
- מצטמצם ועושה יותר רעש

### Speech pattern (make dialogue SOUND like this character):
איטי, עמוק. משפטים קצרים — חוסך מילים כי כל מילה רועמת. אומר "סְ-לִי-חָה" בהברות נפרדות.

### Humor type (this is HOW this companion is funny):
קומדיה של פער קנה-מידה. אוסף פרח קטן ועוקר את כל הצמח. מנסה ללכת בשקט, נופל לפח.

### Body language (drives imageDirection — how emotion shows physically):
רגוע: יושב, רגליים מקופלות, ידיים על הברכיים. מתאמץ-להיות-שקט: גוף כפוף, אצבעות פרושות. נבהל: קופץ והקרקע רועדת.

### Stress response (the companion's signature "meltdown"):
מנסה להצטמצם, מתכופף, מתאמץ ללכת על קצות אצבעות, מחזיק נשימה. בסוף — יושב, הקרקע מקבלת את משקלו ברעידה אחת ואז שקט.

### Comfort ritual (the companion's way of self-soothing — something a child can imitate):
מניח את כפו הענקית על הקרקע — שלוש דקירות עדינות — אומר ללא קול "אֲנִי כָּאן."

### Internal rules (character consistency — things they ALWAYS or NEVER do):
- תמיד שואל "הִפְחַדְתִּי?" לפני שמתקרב
- אסור ללכת לאחור — הצל גדול
- כשמתבייש — שוכב על הקרקע
- אסור להשתמש במילים "ענק", "מפלצת" — המטאפורה היא הסיפור
- ADVENTURE: בסוף, אבן אחת מכיס הענק נשארת על הקרקע. פְּסִיעָה צעד הצידה.
- FANTASY: עולם שבו צעדים מעירים חפצים. החוק לא מתבטל.
...
1. פְּסִיעָה must BEHAVE like a ענק — use species-specific PHYSICAL actions (not just dialogue)
...
**Coping strategy:** WALK SOFTLY (Body Apology) — Pesia preemptively apologizes via body. Every step rehearsed, every breath measured. He believes if I can be quieter than my body suggests, I will not frighten anyone. Cost: he is never fully present — always editing himself.
**Collapse pattern — what BREAKS this defense:** A LAUGH HE CANNOT HOLD IN — something funny happens. He laughs once — thunderclap. Child startles. He realizes his JOY also makes noise, not just his fear.
**Story arc shape — UNIQUE to this companion:** Start in silent-tiptoe mode — Pesia approaching a meadow on toes → child sees him → small whispered interaction → something funny — Pesia laughs once → thunderclap → child startles → mortified → tries to apologize → realizes apology is also loud → sits down hard → child sits beside him, hand on dirt → Pesia mirrors → three soft taps → discovers being big near someone calm doesn't hurt them. Quiet moment is page 11.
...
Some children develop noise-as-shame, believing their body or laughter is a problem. The therapeutic move is to permit the natural sound a body makes when alive.
- Core need: permission to make noise without apology; someone unbothered by their natural sounds
- MUST AVOID: "shhh!" as the lesson; shaming the loudness; naming clinical terms like sensory issues
