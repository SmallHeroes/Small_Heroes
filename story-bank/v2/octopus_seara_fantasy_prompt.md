...
This is a SPECIFIC companion. Use their name, personality, and physical traits throughout.
...
- Special abilities: שמונה זרועות שכל אחת יכולה לעשות משהו אחר; משנה צבע לפי מצב רוח — אדום כשכועס, כחול כשרגוע, סגול כשחושב; יודע להתכווץ ולהיכנס לחורים קטנטנים; משחרר דיו כשנבהל — ענן שחור שמסתיר אותו
- Natural habitat: ocean, coral reef, underwater caves, tide pools
- Narrative hook: כעס הוא אנרגיה — תבחר לאן היא הולכת
...
2. The companion's BODY and ABILITIES drive plot points
3. At least 3 scenes must feature the companion doing something ONLY their species can do
4. Companion MUST speak or act on pages 10-12 (climax). They don't solve it but they react.
5. If companion disappears for more than 2 consecutive pages → rewrite
