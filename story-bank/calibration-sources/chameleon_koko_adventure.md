# Story: chameleon_koko_adventure — CALIBRATION (איתי register, Guy-approved)
# Production slot #7 — use this source, NOT v5-fixed-v2 (עִמִּי formal variant).
# Staged via scripts/stage-golden-v3-import-run.ts → import-v3-approved-story.ts (approval.json required).
...
היא לא הייתה צריכה להאיר את כל הגן. היא לא הייתה צריכה לעשות רעש. "השמש באה איתי," {חשב|חשבה} {{childName}}.
...
{{childName}} {צעד|צעדה} אל שולחן הציור {והתיישב|והתיישבה} ליד הדפים החלקים. קִים חייכה. "האף שלי בא איתי," לחשה. "והשמש שלך באה איתך."
