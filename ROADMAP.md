...
- **Next gate:** no retry follows from technical closure. Any new P1-A1 provider attempt still requires fresh explicit spend authority; unused call/budget headroom is not retry authority. Blueprint, Board/prop LOW images, package work, promotion, rendering, narration and deployment remain unauthorized. P6 Cowork, HOLD/D materialization and the soft narration items remain separate gates.
