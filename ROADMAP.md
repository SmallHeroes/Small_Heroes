...
- **Next gate:** prepare a provider-free, general semantic-recovery Decision Gate for accepted supporting-character authority and fast-locomotion semantics, plus Guy's exact cover and page-12 cart dispositions. Do not special-case P1. Only after the correction independently passes may a fresh P1-only authoring/spend gate be requested. Blueprint, Board/prop LOW images, package work, promotion, rendering, P2, narration, publication and deployment remain unauthorized. P6 Cowork, HOLD/D materialization and the soft narration items remain separate gates.
